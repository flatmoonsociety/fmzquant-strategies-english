...
Huobi held an event for a while, and the HUSD area was free of handling fees, so we created a script to get rid of it.
Stable arbitrage based on the characteristic that it will always return to 1**
...
|----|----|----|
|MAX_ATR|0.0001|Maximum average amplitude|
|ORDER_AMOUNT|1000|Single order amount|
