...
In general, the random point trading strategy relies on the law of large numbers to achieve profits, and sets stop loss and profit to control risks, and is suitable for long-term use by investors with sufficient funds.
||
