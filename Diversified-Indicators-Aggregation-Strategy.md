...
Diversified-Indicators-Aggregation-Strategy
> Author
...
## Overview
This strategy is dedicated to creating the most flexible Bollanger Band strategy, providing a large number of customizable options to meet the needs of different traders.
## Strategy Principle
This strategy uses a single custom moving average as the midline. Allows customizing the period, type and price source of the moving average.
The upper and lower bands are calculated based on the standard deviation of the midline, and the multiple can be customized. You can also choose to use ATR instead of standard deviation to calculate the upper and lower band positions.
This strategy provides a combination of multiple opening and closing conditions, including:
- The price crosses the upper, middle and lower bands
- Price is above or below the upper, middle and lower bands
- Band width is larger or smaller than custom threshold
- Percent B is greater or less than the custom threshold
The conditions for opening and closing positions can be used alone or in combination, and the strategy window can be customized.
Take profit and stop loss can be customized as a percentage.
## Strategic Advantages
- The moving average period, type and price source can be customized to meet different needs
- Various opening and closing conditions can be used individually or in any combination of conditions, with high flexibility
- Supports upper, middle and lower 3 bands, wide observation range
- Supports band width and percentage B as conditions, and can be used in combination with multiple indicators
- Customizable take profit and stop loss percentages, controllable risks
- Supports all varieties of current exchanges and has a wide range of applications
- Customizable backtesting and real-time trading time ranges to facilitate analysis of strategy performance
This strategy greatly improves flexibility by providing a large number of customizable options, and can be personalized and optimized for different varieties and market conditions, thereby obtaining better strategic performance.
## Strategy Risk
- Being too flexible increases the difficulty of combining strategy parameters and conditions, and requires careful testing and optimization.
- Moving average lag may miss short-term opportunities
- Setting the stop loss point too small may increase the risk of exposure
- Percentage B is susceptible to false breakouts
In response to the above risks, the following countermeasures can be taken:
1. Use the backtest function to gradually test different parameter combinations to find the best configuration
2. Assist in using shorter period indicators to identify short-term opportunities
3. Set a reasonable stop loss point based on indicators such as ATR
4. Combine with other indicators to confirm the percentage B signal
## Strategy optimization direction
- Added position management functions, such as fixed positions, martingale, fund management, etc.
- Added automatic switching function for multiple varieties
- Optimize moving average parameters to improve winning rate
- Optimize stop-loss and stop-profit settings to obtain better risk-return ratio
- Test different indicator parameter combinations
- Add machine learning and other algorithms to automatically find optimal parameters
## Summarize
This strategy provides a very flexible and comprehensive trading solution by extending the depth of the Bollanger Band. Although many parameter combinations need to be tested, customized optimization can be carried out according to personal needs. Overall, this strategy has great application value and is a high-quality representative of the Bohrranger band strategy. With continued optimization, especially the introduction of quantitative and machine learning methods, the strategy is expected to produce even better trading performance. It provides traders with a powerful and creative tool.
||
