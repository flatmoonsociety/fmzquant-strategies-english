...
Bollinger moving average breakthrough_vnpy_botvs implementation version
> Author
...
This is to simply encapsulate the interface of botvs using Vnpy writing method to facilitate later calls!
           This was originally a futures strategy, but the parameters were directly changed to apply to Bitcoin.
           For futures, you need to switch to the minute level, and for Bitcoin futures, use the hour level.
           Parameters need to be adjusted during real offer.
           If you have any strategy improvements, please communicate with me 250657661
bar.minute.hour represents the hour level
           bar.minute.minute represents the minute level
> Strategy Arguments
...
|----|----|----|
|ContractTypeIdx|0|Futures type: current week|next week|quarter|
|MarginLevelIdx|0|Margin size: 10|20|
