...
HMA Momentum Breakthrough Strategy HMA-Momentum-Breakthrough-Strategy
> Author
...
![IMG](assets/images/4027b4ae895593f83426714b4967da6d736104dac6252aa368179f5388aff0e0.png)

[trans]

### 2. Strategy Overview
This strategy uses the HMA (Hull Moving Average) indicator and K-line technical analysis to achieve price momentum judgment and breakthrough operations.
### 3. Strategy Principle
1. Principle of HMA indicator
The HMA indicator was created by Alan Hull in 2005 with the goal of creating a moving average that is both sensitive and smooth. The calculation method is:
(1) Calculate the Double Smoothing Average DMA of half period
(2) Calculate the average line SMA of the whole period
(3) Calculate the difference DIFF between DMA and SMA
(4) Calculate the SQRT (period) period average of DIFF and obtain the HMA
2. Trading strategy
The strategy uses the upward breakthrough and downward breakthrough of the HMA indicator as signals, combined with the breakthrough of the physical part of the K-line, to generate buy and sell signals. At the same time, set the stop loss and take profit principles, monitor the profit and loss situation in real time, and achieve profit protection.
### 4. Strategic advantages
1. The "convergence" characteristic of the HMA indicator makes it extremely sensitive to price changes, while maintaining the smoothness of the average line and avoiding false signals.
2. Double breakthrough mechanism to improve signal reliability and avoid being trapped.
3. Dynamic stop-loss, stop-profit and profit protection to optimally control risks and returns.   
4. Fully automated trading, simplified operations.
### 5. Strategic Risks
1. When the market fluctuates violently, the stop loss is more likely to be hit.
2. The transaction frequency is higher and the handling fee cost increases.
3. Improper parameter settings may produce a large number of false signals.
#### Solution
1. Optimize stop-loss and take-profit conditions and set reasonable retracements.
2. Adjust transaction frequency to reduce the impact of handling fees.
3. Test and optimize the HMA cycle and breakthrough conditions to determine the best parameters.

### 6. Strategy optimization direction
1. Combine trend judgment indicators to avoid trading against the trend.
2. Add automatic judgment for data source switching to adapt to more market environments.
3. Add machine learning algorithms to realize automatic optimization of parameters.
4. Add deployment on the server to achieve 24-hour real-time verification.
### 7. Summary
The HMA momentum indicator breakthrough strategy uses the unique advantages of the Hull moving average to accurately capture market momentum. The double breakthrough filtering mechanism improves signal quality, and dynamic stop-profit and stop-loss ensure efficiency. This strategy is simple to use and has obvious effects. It is a very practical quantitative trading tool and is worthy of promotion and application.
||
