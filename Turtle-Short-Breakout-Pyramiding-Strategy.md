...
Turtle-Short-Breakout-Pyramiding-Strategy
> Author
...
This strategy is adapted from the famous Turtle trading system. When the market shows a short trend, short positions are added at key support levels. It is a typical trend breakout strategy.
Strategy principle:
1. Set the 10-day low, 20-day low, and 55-day low as key support lines.
2. When the price breaks through the 20-day or 55-day support line, enter the market short.
3. During the holding period, short positions will be added every time the price falls below a certain ATR.
4. When the price breaks through the 10th or 20th high again, take profit and exit.
5. Set ATR stop loss and exit when the price breaks through.
6. The ATR multiples for multi-level position increase and stop loss can be customized.
Advantages of this strategy:
1. A support line breakout identifies a weak trend turning point.
2. The method of adding positions can accumulate quantity in the trend and pursue higher returns.
3. ATR stop loss can adjust the stop loss distance according to market volatility.
Risks of this strategy:
1. There is a lag in the determination of key support lines, and the best entry point may be missed.
2. Risks accumulate quickly when adding positions, so careful fund management is required.
3. There is no way to limit the size of one-way losses, and there is a large retracement.
In short, this strategy sets a trailing stop while adding short positions. Combining optimization parameters can obtain stronger market increments, but you need to be wary of risk concentration issues.
||
