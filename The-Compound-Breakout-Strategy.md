...
Based on the Compound Breakout StrategyThe-Compound-Breakout-Strategy
> Author
...
1. Calculate the lowest price minLow of the last 7 K lines, which is used to determine the breakout buying conditions.
2. Calculate the highest price maxHigh of the last 7 K lines, which is used to determine the breakout selling conditions.
3. Calculate the simple moving average mma with a length of 200, and determine the trend direction based on the mma indicator.
4. Buying conditions: The closing price close breaks through minLow and is higher than mma
5. Selling conditions: The closing price close breaks through maxHigh or is higher than maxHigh
By calculating the extreme values ​​of the most recent N K lines, we can determine whether the market is oversold or overbought. Combined with the moving average to determine the trend direction, set dual conditions to achieve a breakthrough trading strategy of buying low and selling high.
### Advantage Analysis
This strategy has the following advantages:
1. Double condition setting makes strategic trading signals more reliable
2. Use the K-line extreme value to determine the oversold and overbought status and seize the reversal opportunity.
3. Use moving averages to determine the trend direction and avoid counter-trend operations.
4. It realizes the concept of buying low and selling high, which is in line with the trading psychology of most traders.
5. The strategy logic is simple and clear, easy to understand and implement
Through dual condition confirmation, the strategy signal quality is higher, and the parameter optimization space is large, suitable for different market environments.
### Risk Analysis
There are also some risks with this strategy:
1. Double conditions limit signal frequency and may miss some trading opportunities.
2. The K-line extreme value calculation period is improperly set, and the oversold and overbought status may not be accurately determined.
3. Improper setting of moving average parameters may lead to incorrect judgment of trend direction.
4. Multiple parameters need to be optimized at the same time, and parameter optimization is difficult.
These risks can be reduced by adjusting the calculation cycle and optimizing parameter combinations. In addition, you can also consider combining other indicators for optimization.
### Optimization direction
This strategy can be optimized mainly from the following directions:
1. Optimize the K-line extreme value calculation cycle and find the most suitable cycle parameters for judging overbought and oversold.
2. Test the effect of moving averages of different lengths
3. Add other indicator combinations, such as BOLL channel, KD indicator, etc.
4. Add stop loss strategy and control single stop loss
5. Optimize entry and exit conditions and improve signal quality
...
### Summarize
This strategy is overall a very practical breakout strategy. Calculate the K-line extreme value to determine the overbought and oversold status, the moving average to determine the trend direction, and the dual condition setting to filter out false signals to achieve a high-quality buy low and sell high strategy. The strategy effect can be further improved by optimizing the calculation cycle and adding other indicators. This strategy is suitable for both novices to learn and professional traders to optimize and use.
||
