...
Deribit options Delta dynamic hedging strategy tutorial
> Author
...
|----|----|----|
|isTestNet|true|Whether to switch to simulation disk|
|testNetBase|https://test.deribit.com|模拟盘基地址|
|hedgeDeltaStep|true|Delta hedging step|
|isResetLog|true|Whether to clear the log|



|Button|Default|Description|
|----|----|----|
|setContractType||Set option contract|
