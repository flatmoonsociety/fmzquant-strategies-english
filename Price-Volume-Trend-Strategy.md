...
Momentum indicator tracking short-term price movement strategy-Price-Volume-Trend-Strategy
> Author
...
![IMG](assets/images/5f60cd0799760581df2d0fcb4838b34c0a26201f8d1123b3a0e6eefedde620a1.png)
[trans]
## 

### Overview
This strategy uses momentum indicators to track short-term price changes, determine the direction of market trends, and conduct buy and sell operations. The strategy name is "Price Volume Trend Strategy", which reflects the strategy's idea of ​​using price changes and trading volume changes to determine trends.
### Strategy Principles
This strategy first calculates the price’s momentum. By calculating the difference between the price of the current period and the price of the previous period, the absolute change in price in the latest period can be reflected. A positive value indicates an increase in price, a negative value indicates a decrease in price. Then calculate the moving average of this difference, filter it, and get the average momentum indicator.
When the latest price is greater than the average momentum, it means the price is rising; when the latest price is less than the average momentum, it means the price is falling. Use this indicator to determine the price trend direction. Combined with volume amplification filtering, only signals with larger trading volume are selected in actual transactions.
Carry out corresponding buying and selling operations based on the judged price rising and falling trends.
### Advantage Analysis
- The strategy can quickly judge trends and can quickly capture short-term price changes, making it suitable for short-term operations.
- Filter by trading volume to avoid being misled by false breakthroughs
- Implemented the operating logic of chasing ups and killing downs
- High trading frequency, suitable for active investors
### Risk Analysis
- Vulnerable to abnormal market fluctuations and there is a certain risk of false signals
- Risk of slippage caused by frequent transactions
- May miss the mid- to long-term trend, long-term profitability needs to be verified
...
- Combine more factor judgments to ensure multi-factor driving
### Summarize
This strategy uses momentum indicators to track short-term price trends overall and quickly determine the timing of buying and selling. The advantage is that it can operate quickly and chase the rise and kill the fall; the disadvantage is that the signal quality and long-term profitability need to be considered. Through parameter adjustment and risk control mechanism enhancement, this strategy can become an important part of high-frequency strategies and be used in combination with other low-frequency strategies.
||
