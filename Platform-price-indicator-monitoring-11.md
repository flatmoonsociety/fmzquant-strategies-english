...
1.5---can monitor ATR, RSI, BOLL, PRICE
...
|MaxVal|2755|Maximum value|
|MinVal|2730|Minimum value limit|
|AlarmPeriod|2|Alarm period (unit: polling time)|
|Interval|500|Function retry interval|
|Period|14|Period|
|Index|0|Indicator type: ATR|RSI|BOLL|PRICE|
|RecordsHand|false|Manually collect K lines|
|CleanLog|true|Clean log chart|
