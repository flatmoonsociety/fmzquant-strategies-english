...
## Strategy Principle
This strategy uses the Morning Star K-line pattern to conduct trend-following transactions in the long direction. The main trading signal comes from the point where the Morning Star line breaks through the moving average.
The specific transaction logic is:
1. Calculate the 60-day exponential moving average EMA60
2. Determine the appearance of the Morning Star K-line pattern, including the first negative line, the second cross line or sealing line, and the third positive line that breaks through the highest points of the first two K-lines.
3. The bull signal is the breakthrough point when the morning star line pattern appears above EMA60
4. Set a target profit or trailing stop as an exit strategy
5. The stop loss is set to the lowest point of the past 100 K lines
6. Adjustable morning star line judgment tolerance and other parameters
This strategy makes full use of the trend turning characteristics of the morning star line and tracks the trend direction. Can achieve better results in highly volatile markets.
## Strategic Advantages
- Morning star line effectively determines short-term trend reversal
- Enter the market at the breakthrough point and trail the stop loss, and continue to follow the trend
-Set a lookback window to avoid excessive stop loss
## Strategy Risk
- Parameter settings require repeated testing and optimization
- Stop loss too close may lead to excessive stop loss
- Only go long and miss short opportunities
## Summarize
This strategy identifies the Morning Star K-line characteristics and matches the trend direction for tracking. Parameter adjustment can be used to adapt to different market conditions. But going long only and stop-loss placement requires careful evaluation.
||
