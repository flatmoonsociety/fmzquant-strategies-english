...
![IMG](assets/images/3993ba101015b52c843211089da4909898b0b7c994f761644e44d848f97573c9.png)
[trans]

## 1. Overview
The core of this strategy is the use of adaptive moving averages and momentum indicators to trade breakouts. First, the strategy uses the weighted average price of the hot Lin Yang line and the triple-double smooth moving average to construct an adaptive moving average; then, combined with the momentum indicator, it determines the signal of breakthrough and forms a trading decision.
## 2. Strategy principles
The strategy mainly consists of three parts:
1. Construction of adaptive moving average. The strategy uses the hotline price and triple-double smooth moving averages to construct three adaptive moving averages. These moving averages respond quickly to price changes.
2. Calculation of momentum indicators. The strategy uses the difference between three pairs of smoothed moving averages of price as a momentum indicator. This indicator highlights changes in price trends.
3. Crossover of moving averages serves as a trading signal. A buy signal is generated when the fast moving average crosses the slow moving average; a sell signal is generated when the fast moving average crosses below the slow moving average.
...
1. Use the Relin Yang line price to construct an adaptive moving average, which can respond to price changes more quickly.
2. The triple-double smooth moving average can effectively smooth price data and handle abnormal data.  
...
5. The policy parameter settings are flexible and adaptable.
