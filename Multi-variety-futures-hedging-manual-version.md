...
It is currently a beta version, focusing on strategy exchange and learning, and taking full responsibility for profits and losses in real transactions.
...
|symbolPairs|LTC-USDT-211231|LTC_USDT,BTC-USDT-211231|BTC_USDT|Hedge Control Table|
|cmdHedgeAmount|0.1|The hedging amount of interactive control hedging|
|fuMarginLevel|5|Futures Leverage|
|fuMarginReservedRatio|0.5|Futures margin reserved ratio|
|isOkexV5|true|Whether to use the OKEX V5 interface|
|isOKEX_V5_Simulate|false|Switch OKEX Exchange V5 simulation|
