...
The platform supports strategies to display multiple charts at the same time. This is a simple example.
For specific usage methods, please refer to the Chart section in the API document https://www.fmz.com/api#chart
