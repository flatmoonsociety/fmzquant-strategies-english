...
|----|----|----|
|TradeSymbols|BTC,ETH,BCH,XRP,EOS,LTC,TRX,ETC,LINK,XLM,ADA,XMR,DASH,ZEC,XTZ,BNB,ATOM,ONT,IOTA,BAT,VET,NEO,QTUM,IOST|
|TradeValue|50|Holding value for every 1% deviation from the index|
|DeviateValue|20|Contract value adjustment deviation value|
|IceValue|20|Iceberg Commission|
|LogInterval|600|Log total equity interval s|
|Interval|5|Sleep time s|
|MockTrading|false|Mock trading|
|MockTradingValue|100000|Mock trading amount|
|Reset|false|Reset|
