...
|----|----|----|
|specifiedAmount|-1|Specified synchronization amount|
|zoomAmountRatio|-1|Sync amount zoom|
|amountPrecision|2|Order quantity precision|
|pricePrecision|2| Price precision|
|isSimulateOKEX|false|Whether to use OKEX simulation disk|



|Button|Default|Description|
|----|----|----|
|stop/restart||Stop following orders|
