...
Trend following trading strategy based on MACD indicator MACD-Trend-Following-Trading-Strategy-Based-on-MACD-Indicator
> Author
...
## Overview
This strategy determines the trend direction based on the MACD indicator and performs specific buying and selling operations in combination with the Stoch indicator. The strategy uses the longer-period MACD to determine the general trend, and the shorter-period Stoch to enter and exit the market.
## Strategy Principle
1. Use MACD indicator to determine the general trend direction
- Calculate long-period EMA fast lines, slow lines and MACD histograms    
- Compare changes in MACD in different periods and determine the trend direction    
2. Use the Stoch indicator to determine specific buying and selling points
- Calculate %K line and %D line    
- Stoch appears a divergence near the overbought and oversold zone and pulls back, serving as a buy and sell signal
3. Combine trend direction and Stoch signals to perform buying and selling operations
- When the macro-cycle MACD rises, the Stoch buy signal appears, go long    
- When the macro-cycle MACD falls, the Stoch sell signal appears and go short.    
4. Set stop loss and stop profit to optimize fund management
## Advantage Analysis
- This strategy combines trend tracking and overbought and oversold indicators to effectively capture medium and long-term trends.
- MACD determines the general direction, and Stoch carries out transaction details, which can effectively control risks.
- Make full use of the combination of indicators to form an indicator strategy
- Set up a stop-loss and stop-profit mechanism to manage trading risks
- Strategy parameters can be optimized and suitable for different market environments
## Risk Analysis
- There may be errors in the judgment of medium and long-term trends, resulting in losses in counter-trend transactions.
- The Stoch indicator generates false signals, resulting in insufficient profits or losses.
- When the trend changes, the stop loss point may be breached, expanding losses.
- If the profit target is too large or too small, it will affect the effectiveness of the strategy.
- Improper parameters and failure to adapt to changes in the market environment will lead to strategy failure
- Risks can be reduced by optimizing trend judgment methods, verifying Stoch signals, and adjusting stop-loss and take-profit positions.
## Optimization direction
- Optimize the MACD parameter combination to improve the accuracy of trend judgment
- Consider multi-time period Stoch indicators to avoid false signals
- Dynamically adjust the stop-loss and take-profit ratios to adapt to market fluctuations
- Verify in combination with other indicator signals to improve signal effectiveness
- Optimize parameters according to different product characteristics and trading periods
- Add machine learning algorithm to assist in determining trend direction
- Combined with volume and energy indicators to avoid insufficient or excessive pursuit of rises and falls
## Summarize
This strategy integrates the advantages of two indicators, MACD and Stoch, and captures the medium and long-term trends for trading while controlling risks. Strengthening the strategy effect through parameter optimization, stop loss and profit setting, signal verification and other methods, it can adapt to various market environments and has actual trading value. There is still room for optimization, and parameter settings can be continued to be optimized to improve signal accuracy, supplemented by machine learning and other means to make the strategy more comprehensive and intelligent.
||
...
|v_input_16|30|MACDCHA step size|
|v_input_17|20|MACDCHA step size 2|
|v_input_18|10|MACDCHA step size 3|
|v_input_19|5|MACDCHA step size 4|
|v_input_20|3|MACDCHA step size 5|
|v_input_21|true|MACDCHA step size 6|
|v_input_22|50|hist step size|
|v_input_23|4|Long stop loss %|
|v_input_24|10|Go long and take profit %|
