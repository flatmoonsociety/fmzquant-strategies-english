...
Spot single currency balancing strategy
> Author

grass
> Strategy Description

The most classic single-currency balancing strategy is to sell when the price rises and buy when the price falls, always maintaining a certain proportion of positions. A more moderate strategy that requires long-term operation.
...
|Grid_Ratio|0.005|Adjust ratio|
|Advance|false|Show more parameters|
|Intervel|1000|Sleep time ms|
|Log_profit|600000|Print profit time ms|
