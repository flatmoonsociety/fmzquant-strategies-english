...
1.4---Add alarm cycle setting
1.3---Add WeChat notification
1.2---Support futures platform
1.1---stable version
> Strategy Arguments
...
|----|----|----|
|CType0|0|Currency type: RMB|USD|
|ContractType0|0|All 0 contract types: current week | next week | current month | quarter |
|MLevel0|0|So 0 leverage size: 10x|20x|
|ContractType1|0|Contract type: current week | next week | current month | quarter |
|MLevel1|0|The leverage size of all 1: 10 times|20 times|
|LoopInterval|5000|Polling interval (milliseconds)|
|MaxVal|105|Maximum value|
|MinVal|102|Minimum value limit|
|AlarmPeriod|20|Alarm period (unit: polling time)|
|CType1|0|Currency type: RMB|USD|
|Interval|1000|Function retry interval|
|Price0|0|So0 price type: Asks[0]|Last|Bids[0]|
|Price1|0|So1 price type: Asks[0]|Last|Bids[0]|
...
|----|----|----|
|Push switch|__button__|WeChat push|
