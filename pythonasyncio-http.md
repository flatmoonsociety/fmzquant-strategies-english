...
**True asynchronous, in fact, asynchronous is enough to obtain market prices. After a signal occurs, use event-driven operation of the corresponding currency, and use the synchronous interfaces encapsulated by the platform. **
