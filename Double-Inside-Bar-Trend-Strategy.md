...
### Strategy Principles
1. Calculate the Hull Moving Average as an indicator of trend.
2. When a secondary contained pattern appears, it is considered a trading signal with a higher probability. The included pattern is a pattern in which the highest and lowest prices of the first two K lines are included by the third K line.
3. If the closing price is above the moving average and a long inclusion is formed, place a buy stop order near the high point of the included pattern; if the closing price is below the moving average and a short inclusion is formed, place a sell stop order near the low point of the included pattern.
4. Once the stop order is triggered and executed, set stop loss and take profit orders according to the preset stop loss range and take profit ratio.
### Advantage Analysis
1. Contained patterns provide higher probability reversal signals. The emergence of a double inclusion pattern may indicate a short-term price reversal.
2. Used in conjunction with moving averages, it can operate in the direction of the general trend and increase the probability of profit.
3. Use stop orders near the breakthrough point during the trend to open a position to get a better entry opportunity.
### Risk Analysis
1. In a volatile market, the trading signals provided by the embedded patterns may cause frequent losses.
2. As an indicator for judging trends, moving averages may also send out wrong signals, leading to losses in counter-trend transactions.
3. If the stop loss point is set too small, the stop loss may be triggered by a small price slippage.
### Optimization direction
1. You can test moving averages of different parameters as indicators for judging trends.
2. It can be combined with other indicators to filter the volatile market and avoid blind trading when there is no clear trend. 
3. Better parameter combinations can be obtained through big data analysis, such as moving average period, stop loss multiple, take profit ratio, etc.
4. Filtering conditions for trading time and varieties can be added to adapt to the characteristics of different time periods and varieties.
### Summarize
The double inclusion and trend strategy uses the double inclusion pattern to provide higher probability trading signals, and at the same time assists the moving average to determine the direction of the general trend, and goes long and short in the direction of the trend. It is a relatively stable breakthrough strategy. Through parameter optimization and rule optimization, the strategy can be more adaptable to the market and have a higher probability of profit.
||
