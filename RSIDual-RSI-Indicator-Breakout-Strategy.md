...
## Strategy Principle
The Double RSI Indicator Breakout Strategy uses two Relative Strength Index (RSI) indicators for trading, a fast RSI and a slow RSI, both of which can be traded in the same direction.
...
5. Close the position when the rapid RSI crosses 70
6. Close the position when the slow RSI crosses 68
7. Set retracement stop loss level
The double RSI indicator can find better opportunities in overbought and oversold areas. The combination of fast and slow lines can achieve multi-level entry and follow trend operations. Stop loss controls risk.
...
- Double entry will increase the risk factor of trading
