...
This strategy uses the difference curve breakthrough of the MACD indicator to make trading decisions. MACD is composed of fast and slow EMA, and a trading signal is generated when the difference curve breaks through the zero axis. This strategy is a typical tracking quantitative trading strategy.
Strategy principle:
1. Calculate the fast EMA and slow EMA, and the difference between the two forms the MACD curve.
2. Perform EMA smoothing on the MACD curve to obtain the MACD signal line.
3. Go long when MACD crosses above the signal line, and go short when it crosses below the signal line.
4. Set percentage stop loss and profit points for risk management.
Advantages of this strategy:
1. The MACD indicator is better than a single EMA and can judge the trend more clearly.
2. Use breakthrough trading methods to capture turning opportunities in a timely manner.
3. The stop-loss and stop-profit mechanism helps control trading risks.
Risks of this strategy:
1. There may be more false breakthrough signals near the zero axis of the MACD curve.
2. Parameters need to be optimized to match different trading varieties.
3. Trend trading is easily affected by emergencies and must set a stop loss.
In short, this strategy uses the breakthrough relationship of the MACD difference curve to make judgments. The advantages of the MACD indicator are conducive to improving the effect, but you need to be wary of the risk of false breakthroughs and take appropriate risk management measures to obtain long-term stable returns.
||
