...
Idea:
1. Normal grid.
2. Close positions to avoid risks when prices fall.
3. When hedging, make a virtual offer, and then make a real offer when the profit is sufficient.
(Under the backtest of this idea, it was impossible to avoid a catastrophic disaster, so it was open sourced for everyone to laugh at.)
What if you change it and you can make money.
> Strategy Arguments
...
|----|----|----|
|UI_AttackRatio|true|Amount usage ratio|
