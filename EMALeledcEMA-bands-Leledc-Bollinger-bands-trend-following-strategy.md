...
Trend following strategy EMA-bands-Leledc-Bollinger-bands-trend-following-strategy based on EMALeledc and Bollinger Bands
> Author
...
![IMG](assets/images/07dc2095fb2c8e139f5dfd9c851f27ad690f7e6527c8f89131c7f5cb3adc5d16.png)
[trans]

## Overview
This strategy is a position-based trend following strategy that uses a combination of EMA bands, Leledc exhaustion lines, and Bollinger Bands to identify trends and establish long or short positions when the trend signals.
## Strategy Principle
### Conditions for opening a position
- When the price breaks through the midline EMA band (that is, the middle price of the high EMA and the low EMA), go long; when the price breaks below the midline EMA band, go short.
- You can choose to enable the slow EMA filter. A position will only be opened when the closing price breaks through the midline EMA band and the slow EMA is in the same direction.
- You can choose to enable the re-breakout signal after the midline EMA breaks down, and the position will only be opened when the price touches the midline EMA band again.
### Conditions for closing positions
- Select the nearest band stop loss, and stop loss when the price touches the midline EMA band in the opposite direction.
- Choose stop loss in the opposite band, and stop loss when the price breaks through the midline EMA band in the opposite direction.
- Delayed stop loss can be selected. If the price hovers within the midline EMA band for a certain period, the loss will be stopped.
- Option to stop loss at Leledc exhaustion line. When several consecutive K lines close in the same direction and hit the highest or lowest price in the near future, it is judged that the trend is over and stop loss.
- Choose to stop loss at the Bollinger Bands regression line. When the price returns to the middle track of the Bollinger Bands in the overbought and oversold area, it is judged that the trend is over and the loss is stopped.
- You can choose to stop loss when breaking out of the buying zone or selling zone. When the price breaks through the internal or external buying zone or selling zone, it is judged that the trend is over and the loss is stopped.
### Reverse opening conditions
- When the Leledc exhaustion line or the Bollinger Band regression line appears, and the extreme point breaks through a certain range of the buying zone or selling zone, you can choose to open a position in the opposite direction.
- Inverse positions have independent stop loss conditions to choose from.
## Strategic Advantages
- Use the EMA band to determine the trend direction and avoid being misled by the volatile market.
- The Leledc exhaustion line can effectively determine the end of the trend, and the Bollinger Bands regression line confirms the timing of over-expansion of long and short positions. The combination of the two can ensure the trend tracking effect.
- After enabling reverse position opening, you can conduct range trading in volatile markets and track more markets in trending markets.
- The drawing of the midline EMA band, buying area and selling area can intuitively determine the direction and strength of the current trend.
## Strategy Risk
- The EMA indicator is sensitive to parameter settings. Improper EMA length setting may lead to chaotic positions.
- Leledc exhaustion line and Bollinger Band regression line, as technical indicators to judge the end of the trend, may also fail, thus missing the stop loss point and causing large losses.
- Opening a position in the reverse direction increases the risk of the strategy, and a stop loss must be set to control the risk.
## Strategy optimization
- You can test different EMA length parameters to find a parameter combination that is more suitable for the variety and period.
- The parameters of Leledc exhaustion line and Bollinger Band regression line can be adjusted to find indicator parameters that can more accurately judge the end of the trend.
- The stop loss point for reverse opening can be further optimized to better match the risk and return of reverse trading.
- The midline EMA band can be replaced by a simple moving average or other indicators to find a more stable technical indicator for judging the trend midline.
## Summarize
This strategy integrates a variety of technical indicators and technical methods such as trend judgment, exhaustion point confirmation and reverse trading entry, and it can be said to be fully functional. On the premise that parameter adjustment and risk control are in place, excellent and stable returns can be obtained, which is worthy of further research and optimization.
|| 
