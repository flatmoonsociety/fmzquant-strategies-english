...
|zhis|100|Stop loss%|
|autoMoveStocks|false|Automatically move out 100U when the available assets are greater than *U|
...
|----|----|----|
|Clearance shutdown|__button__|Clearance shutdown|
