...
Momentum trading strategy based on QQE indicator QQE-Momentum-Trading-Strategy
> Author
...
![IMG](assets/images/b7eb6b2c697575b97816d4e147db5e995486960eb9f7518ff99b2e8e4f43cede.png)
 [trans]

## Overview
This strategy is a momentum trading strategy based on the QQE (Quantitative Qualitative Estimation) indicator. It uses the QQE indicator to identify opportunities in stock prices and combines it with the moving average indicator to filter out false signals.
## Strategy Principle
This strategy uses the crossover of 3 QQE indicators to identify buy/sell opportunities:
1. The QQE curve crosses the 0 axis (XZ): represents an early signal that the stock price is reversing in the overbought/oversold zone.
2. The QQE curve crosses the fast QQE line (XQ): It represents the opportunity for short-term adjustment in stock prices.
3. The QQE curve crosses the RSI range channel (XC): It represents the opportunity for mid-term adjustment of the stock price.
When a buy/sell signal is recognized, the strategy also checks the moving average indicator as an additional filter to avoid false trades in non-trending situations:
1. The fast moving average is higher than the medium moving average, and the medium moving average is higher than the slow moving average.
2. The direction of the medium-speed moving average is upward (long signal) or downward (short signal).
## Strategic Advantages
This strategy combines the QQE indicator to identify buy/sell opportunities and moving average filtering to improve signal quality. It has the following main advantages:
1. Different cross combinations of QQE indicators identify opportunities at different levels of stock prices.
2. The moving average effectively filters out false signals such as false breakthroughs.
3. The configurable parameters are flexible and suitable for different varieties and time periods.
4. The QQE indicator combination can be used alone or in combination with other filtering indicators.
## Strategy Risk
This strategy mainly involves the following risks:
1. More false signals may be generated in volatile markets.
2. As a Lagging indicator, the moving average sometimes filters out some correct signals.
3. Improper parameter settings may lead to expanded retracements or missed opportunities.
4. Appropriate stop-profit and stop-loss mechanisms are needed to control single losses.
## Strategy optimization
This strategy can be optimized from the following aspects:
1. Adjust QQE parameters to adapt to stocks with different volatility.
2. Optimize the moving average parameters and improve the filtering effect.
3. Add other conditions, such as transaction volume filters, etc.
4. Add a stop-loss and stop-profit mechanism to control trading risks.
5. Evaluate real transaction results and optimize important parameters.
## Summarize
This strategy integrates the buying and selling point identification of the QQE indicator and the direction filtering of the moving average to form a high-quality momentum trading strategy. The policy parameters are highly configurable and can meet differentiated needs. After adding appropriate stop-profit and stop-loss, you can expect to obtain stable income.
||
