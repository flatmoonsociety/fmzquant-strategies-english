...
Spot hedging strategy for different denomination coins-Ver11
> Author

Inventor Quantification-Little Dream
> Strategy Description

## Spot hedging strategy for different denominated currencies Ver1.1
...
|hedgeDiffPriceA2B|20|Hedge DifferenceAtoB|
|hedgeDiffPriceB2A|20|Hedge DifferenceBtoA|
|hedgeDiffPercentageA2B|4|Hedge Diff PercentageAtoB|
|hedgeDiffPercentageB2A|4|Hedge Diff PercentageBtoA|
|minHedgeAmount|0.005|Minimum order amount for hedging|
|maxHedgeAmount|0.2|Maximum hedging order amount|
|rateA|true|A exchange rate|
|rateB|true|B exchange rate|
|isReset|false|Reset all information|
|pricePrecisionA|2|A price precision|
|amountPrecisionA|3|A order quantity precision|
|pricePrecisionB|2|Bprice precision|
|amountPrecisionB|3|B order quantity precision|
|slidePrice|true|Place an order with sliding price|
|marginType|0|Leverage Type: Ordinary Coin|Isolated Margin Leverage|Cross Margin Leverage|



|Button|Default|Description|
|----|----|----|
|A2B|false|Modify the parameters of AtoB|
