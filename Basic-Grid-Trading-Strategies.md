...
Currently this is not the optimal version. I am currently running Binance’s websocket version.
If you need it, I will change Binance’s websocket version to a version suitable for running on Inventor.
> Strategy Arguments
...
|----|----|----|
|trading_pair|BTC_USDT|Trading pair|
|lower_price|false|range lower limit price|
|upper_price|false|range upper limit price|
|grid_num|2|Grid number|
|trading_per_grid|false|Purchase quantity per grid|
|price_precision|2|Order price precision|
|amount_precision|5|Order quantity precision|
