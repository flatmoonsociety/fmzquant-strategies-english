...
Digital currency spot multi-variety double moving average strategy teaching
> Author

Inventor Quantification-Little Dream
> Strategy Description

Related articles: https://www.fmz.com/bbs-topic/8512
> Strategy Arguments
...
|----|----|----|
|symbols|ETH_USDT,ETC_USDT,LTC_USDT|Trading pair code|
|ema1Periods|10,15,20|The first EMA indicator|
|ema2Periods|15,20,25|Second EMA indicator|
|orderAmounts|1,1,1|Order amount, number of coins|
|takeLevel|10|Take level|
