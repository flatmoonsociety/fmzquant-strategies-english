...
Trend-and-Oscillation-Double-Strategy, a quantitative trading strategy that combines trends and oscillations
> Author
...
![IMG](assets/images/80eed3668f4648e1e01b9225a7708e3d123567a2ea61ae0a7c7fe5071ed73887.png)

[trans]

## Overview
The dual trend oscillation strategy is a quantitative trading strategy that combines trends and oscillations. It uses a combination of two indicators to identify the direction and strength of the trend, and to find better entry opportunities when the trend fluctuates.
## Strategy Principle
This strategy primarily utilizes two public indicators: Trend Surfers and Mawreez's Trend Oscillator.
Trend Surfers is a trend following stop loss indicator. It determines the price trend and gives suggested stop loss positions by calculating the highest and lowest prices within a certain period. For example, when the price breaks through the highest price of the last 168 K lines, it is a bullish signal; when the price falls below the lowest price of the last 168 K lines, it is a bearish signal.
Mawreez's Trend Oscillator is a two-line oscillator. It is similar to MACD and uses the difference in DI to determine the direction and strength of the trend. The indicator curve is bullish when it is above the 0 axis, and bearish when it is below it.
The trading rules of this strategy are:
Bullish Entry: Buy When Trend Surfers Break Above Top Line and Mawreez's Trend Oscillator Is Bullish
Short Entry: Sell When Trend Surfers Break Below Low Line and Mawreez's Trend Oscillator Indicator Is Bearish
The stop loss method is trend following stop loss plus fixed stop loss.
## Advantage Analysis
This strategy combines trend and oscillator indicators, which can not only capture the trend, but also find better price entry in the oscillation. It has the following advantages:
1. Double indicator filtering can effectively avoid false breakthroughs
2. Combining trends and shocks, it is easy to seize the low-level accumulation layout of the price in the shock range or to carry out light operations at high levels.
3. Using multiple stop-loss methods can effectively control risks.
## Risk Analysis
There are also some risks with this strategy:
1. Double indicator combination makes it easy to miss orders
2. Trend indicators and oscillators can send conflicting signals
3. Fixed stop loss may stop loss prematurely
To address these risks, the following measures can be taken to avoid them:
1. Appropriately relax the indicator parameters and reduce the filtering rate
2. Add trend judgment rules to avoid indicator conflicts
3. Dynamically adjust stop loss position
## Optimization direction
There is room for further optimization of this strategy:
1. Test different parameter combinations and period parameters to find the best parameters
2. Add volatility, trading volume and other auxiliary judgment rules
3. Use machine learning technology to dynamically optimize indicators and parameters
## Summarize
The dual-trend oscillator strategy comprehensively uses the advantages of trend tracking and oscillators. It can not only identify the trend direction but also seize the oscillation opportunities. Through parameter and rule optimization, the profitability of the strategy can be further improved. This strategy has good development prospects.
|| 
