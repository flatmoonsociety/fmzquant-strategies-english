...
![IMG](assets/images/7fdb4b82eecab8f40853fde6116eb65e39569b39fe391e91852ee382d587eff2.png)
 [trans]

## Overview
The double confirmation quantitative trading strategy combines two sub-strategies, the 123 reversal strategy and the percentage volume oscillator (PVO), to achieve double confirmation of trading signals and reduce trading risks. This strategy is mainly suitable for medium and long-term position trading.
## Strategy Principle
### 123 Reversal Strategy
The 123 reversal strategy is implemented based on the K-line form of the stochastic indicator. Specifically, go long when the closing price is lower than the closing price of the previous day for 2 consecutive days, and the 9-day slow stochastic indicator is below 50; go short when the closing price is higher than the closing price of the previous day for 2 consecutive days, and the 9-day fast stochastic indicator is above 50.
### Percent Volume Oscillator (PVO)
PVO is a volume-based momentum oscillator. It measures the difference between two different periodic volume exponential moving averages and the ratio of the longer period average, expressed as a percentage. When the short-period average is higher than the long-term average, it is positive, and vice versa. This indicator reflects the rising and falling trend of trading volume.
## Advantage Analysis
This strategy combines price indicators and trading volume indicators to effectively filter out false breakthroughs. At the same time, through the double confirmation mechanism, transaction frequency can be reduced and transaction risks can be reduced.
## Risk Analysis
This strategy relies on a long holding period and has the risk of retracement. In addition, improper parameter settings can also lead to excessive trading frequency or missed signals.
## Optimization direction
The performance of the sub-strategy can be optimized by adjusting the parameters of the stochastic indicator and PVO. Stop-loss mechanisms can also be introduced to control risks. In addition, filtering signals in combination with other indicators can further improve the stability of the strategy.
## Summarize
The double confirmation quantitative trading strategy comprehensively considers price and trading volume factors, and the backtesting effect is ideal. Through parameter tuning and optimized signal filtering, this strategy is expected to further enhance stability and become a powerful tool for quantitative trading.
||
