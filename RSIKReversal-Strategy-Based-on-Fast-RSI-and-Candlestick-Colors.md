...
[trans]
The name of this strategy is "Reversal Strategy Based on Fast RSI and K-line Color". This strategy uses fast RSI to determine overbought and oversold and the color of the K-line to determine the trend direction, and perform reversal trades when the two send common signals.
The fast RSI indicator parameter setting is smaller and can capture overbought and oversold price phenomena more quickly. When the Rapid RSI is below 30 it means oversold, and above 70 it means overbought.
The color of the K-line is white, which means the price closed near the opening price, green, which means the price has increased, and red, which means the price has fallen.
The transaction logic is as follows:
When the fast RSI shows oversold and 4 consecutive red K lines appear, it is regarded as a strong reversal signal and goes long;
When the fast RSI shows overbought and 4 consecutive green K lines appear, it is regarded as a strong reversal signal and goes short;
If you currently hold a long position, the position will be closed if a green K line appears; if you currently hold a short position, if a red K line appears, the position will be closed.
The advantage of this strategy is that the indicator combination is accurate and reliable in judging reversal signals. However, due to the large investment intensity, strict fund management is required. A stop loss strategy is also required.
Overall, reversal trading relies on indicators to accurately determine timing. Reasonable application of indicators such as RSI and supplemented by K-line information can improve the strategy effect. However, no single strategy can be perfect, and traders still need to maintain flexibility in trading thinking.
