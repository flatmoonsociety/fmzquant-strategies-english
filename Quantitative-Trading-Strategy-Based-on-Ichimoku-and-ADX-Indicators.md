...
![IMG](assets/images/20166296e2157b0f9d36ba493b7eeab7694912e74e435279ccd515d0c37deb92.png)
 [trans]

### Overview
This strategy uses a combination of two technical indicators, the Ichimoku Balance Sheet and the Average Directional Index (ADX), to identify trends and key support and resistance levels in a stock's price to generate buy and sell signals. This strategy is designed to capture larger price swings in trending markets.
### Strategy Principles
The Ichimoku balance sheet contains three moving averages: the pre-conversion line, the base line and the delay line. When the price crosses above the previous conversion line and the base line, a buy signal is issued; when the price crosses below these two lines, a sell signal is issued. In addition, Ichimoku also identifies key areas of support and resistance through cloud charts.
ADX is used to judge the strength of price trends. When +DI and -DI are clearly separated, it indicates a trend market; when +DI and -DI are close to each other, it indicates a consolidation market. This strategy only sends trading signals when ADX is greater than 20 to avoid catching false breakthroughs during the consolidation period.
By comprehensively using the Ichimoku's trend judgment and ADX's filtering of trend strength, we can effectively identify trend segments with large price fluctuations.
### Strategic Advantages
- Use a combination of two indicators to make trading signals more reliable
- The use of ADX avoids wrong transactions during consolidation market
- The backtest performance is good and the return-to-risk ratio is high
### Risk Analysis
- This strategy is more suitable for trending stocks. For consolidating stocks, there may not be many signals.
- The Ichimoku Balance Sheet itself has a problem of delayed response and may miss the opportunity for rapid reversal.
- ADX's judgment of the consolidation market is not perfect, and there is still the possibility of misjudgment
### Optimization direction
- Can test different parameter combinations, such as adjustment of conversion line and baseline period
- Can be combined with other indicators, such as MACD, KD, etc. for further optimization
- Can research different ADX filtering rules or conditions
### Summarize
This strategy achieves effective capture of trend market conditions through the effective combination of Ichimoku Balance Sheet and ADX. Based on further optimization of parameters and rules, this strategy can achieve better backtesting and real-time performance. This strategy is suitable for strategic investors who trade trend stocks.
||
