...
Spot, open long, open short, stop loss, add position, close position.
// - status
/*
var TASK_IDLE = 0;
...
|MaxAmount|0.8|Maximum single order amount for opening a position|
|RetryDelay|500|Failed retry (milliseconds)|
|Interval|500|Polling interval|
|_minStock|0.01|Minimum number of transaction coins|
