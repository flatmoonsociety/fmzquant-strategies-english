...
![IMG](assets/images/bdb778ce9ce3372e5876e7ae061f70403aa3c14c5cbd40db047a413eb24e434a.png)
[trans]

### Overview
This strategy uses the golden cross and dead cross of the double EMA indicator to determine the current trend direction, and combines it with the RSI indicator to avoid missing buying and selling opportunities. It is a typical trend following strategy.
### Strategy Principles
1. Calculate the 10-period and 20-period EMA moving averages, named ma00 and ma01 respectively.
2. A buy signal is generated when ma00 crosses above ma01
3. A sell signal is generated when ma00 crosses ma01
4. At the same time, when the price crosses ma00, if ma00 is higher than ma01, a buy signal will also be generated.
5. Similar to when the price falls below ma00, if ma00 is lower than ma01, a sell signal will also be generated.
6. Through this double judgment, you can avoid missing some buying and selling points
7. Set stop loss and take profit prices to achieve risk control
### Advantage Analysis
1. Using double EMA judgment can effectively filter out false breakthroughs
2. Double condition judgment to avoid missed orders
3. Stop-loss and stop-profit settings are beneficial to risk control
### Risk Analysis
1. The double EMA moving average strategy is a trend following strategy. In volatile market conditions, buying and selling are frequent and it is easy to stop losses.
2. Failure to accurately judge the trend reversal point may lead to losses
3. Improper setting of stop loss points may expand losses
### Optimization direction
1. You can appropriately optimize the EMA period and find the best parameter combination
2. You can add other indicators for judgment to improve the stability of the strategy.
