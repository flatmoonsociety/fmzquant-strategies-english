...
MACD buy low sell high automatically follow orders sliding stop
> Author
...
|----|----|----|
|ac1|0.005|First bar after cross|
|bc1|-1e-06|Previous bar after cross|
|SlidePrice|0.3|Sliding Price|
|TrailingStop|0.5|Stop loss point|
|orderTimeout|30|Buy order timeout (seconds)|
|MinStock|30|Minimum stock position|
