...
![IMG](assets/images/2a13e69af09f1c508ca43afa2753a0748447a1e2d4abaadeb049bac095ddb002.png)
 [trans]

## Overview
This strategy is based on dual moving averages and relative strength indicators, combined with the stock's historical volatility, to achieve automatic buying and selling of stocks. The advantage of the strategy is that it combines long-term and short-term strategies and can effectively control risks. However, there is also some room for improvement, such as adding a stop-loss mechanism.
## Strategy Principle
The strategy uses a dual moving average system consisting of a 150-week linea moving average and a 50-day fast moving average, as well as a 20-day fast moving average. When the price crosses the 150-day moving average, it is considered that the market starts to rise, and when the price crosses the 50-day moving average, it is considered that the market starts to fall. In this way, you can chase the rise and kill the fall when the market is rising, and stop the loss at any time when the market is falling.
In addition, the strategy uses annualized volatility peaks and relative strength indicators to determine specific buying opportunities. A buy signal will only be issued when the closing price exceeds the highest price calculated by annualized volatility and the relative strength indicator is positive.
## Strategic Advantages
1. The use of the double moving average system can effectively judge changes in the main trend and achieve chasing ups and downs.
2. The addition of volatility indicators and strength indicators can avoid following the trend in volatile market conditions.
3. The addition of the 20-day fast moving average can stop losses faster
## Strategy Risk
1. There is a certain lag and the loss cannot be stopped quickly.
2. Failure to set a stop loss position may result in larger losses.
3. Lack of parameter optimization, parameter settings are subjective
In order to solve the risk, you can set a stop loss level, or use the multiple of the ATR indicator as the stop loss range. In addition, parameters can be optimized through more rigorous backtesting.
## Strategy optimization direction
1. Add stop loss mechanism
2. Use parameter optimization method to find optimal parameters
3. Consider adding other indicators to filter signals, such as trading volume indicators, etc.
4. You can consider building the strategy into a multi-factor model and combining more indicators
## Summarize
This strategy is generally a relatively conservative stock investment strategy. Using double moving averages to determine the main trend, and combining volatility and strength indicators to enter the market, can effectively filter out false breakthroughs. The addition of fast moving average also makes stop loss faster. However, the strategy can be further optimized, such as adding a stop loss mechanism and using parameter optimization and other means. In general, this strategy is suitable for investors who hold stocks for the long term.
||
