...
![IMG](assets/images/90f239e313ba68799db2e448589f3caba3edebcb33d9b44c9a8768c57577fb10.png)
[trans]

## Overview
This strategy is an automatic trading strategy that uses the size of the K-line entity and the trend momentum indicator EMA to determine the market trend and achieve buy low and sell high. The basic idea is to chase the rise and kill the fall in the rising market, and to cover the long position in the falling market.
## Strategy Principle
1. According to the size of the K-line entity, candles are divided into three types: slag candles, small candles, and large candles.
2. When the EMA rises, if a big red candle appears, it means that the market is adjusting, and you should sell a long order at this time.
3. When the EMA decreases, if a big green candle appears, it means that the market has stabilized. At this time, increase the position.
4. Dynamically adjust positions by monitoring K-line entity changes and EMA trends in real time.
## Advantage Analysis
1. The strategic ideas are clear and the market structure can be judged through simple indicators, which is easy to understand.  
2. The strategy has fewer parameters, is not easy to overfit, and has high stability.
3. Realize the trading logic of buying low and selling high, and make obvious profits when the market fluctuates significantly.
4. Take into account both trends and reversals, and be able to respond promptly when the market changes.
## Risk and Optimization
1. Failure to consider the absolute range of the stock price may lead to stop loss risks. Stop loss can be combined with the ATR indicator.
2. Without considering the basis difference of cryptocurrency, more trading pairs can be tested.
3. Machine learning algorithms can be introduced to assist in judging the K-line form.
4. You can filter varieties by combining trading volume indicators.
5. Can test parameter adjustments in different cycles.
## Summarize
The overall idea of ​​this strategy is clear and easy to understand, and it mainly highlights the two characteristics of "momentum" and "tracking". The simple EMABOLL indicator is used to determine the main line direction of the market, and the K-line entity determines local adjustments to achieve efficient trading of buying low and selling high. The strategy has high stability and performs particularly well in cryptocurrencies, and is worthy of further testing and optimization.
||
