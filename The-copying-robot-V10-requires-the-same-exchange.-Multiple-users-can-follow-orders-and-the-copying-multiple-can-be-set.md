...
The copying robot V10 requires the same exchange. Multiple users can follow orders and the copying multiple can be set.
> Author
...
|isSimulate|false|Whether to use simulation disk|
