...
Pivot-Point-Golden-Ratio-Buy-High-Sell-Low-Strategy based on the Pivot-Point-Golden-Ratio-Buy-High-Sell-Low-Strategy
> Author
...
![IMG](assets/images/5c7db6b2ef65739a90c97065248aa785b918d6c18c28274236cd3d739dee1bbf.png)
[trans]

## Overview
This strategy calculates the fulcrums of different time periods as key price areas, combines the golden section principle to determine the trend direction, and implements a trading strategy of buying high and selling low.
## Strategy Principle
1. Calculate the pivot points of closing price, highest price and lowest price in different time periods. Includes classic pivot points and golden section pivot points.
2. Determine the current price area based on the price breaking through the upper and lower rails. Divided into 5 buying areas and 5 selling areas.
3. Send a buy signal in the buy area and a sell signal in the sell area, adopting a buy high and sell low strategy.
## Advantage Analysis
1. Use multiple time periods to determine trends and avoid being misled by market noise.
2. Combine the classic fulcrum and the golden section fulcrum at the same time to improve the reliability of the fulcrum.
3. Determine the timing of market entry through the price area to avoid the risk of loss to the greatest extent.
4. Adopt a buy high and sell low strategy, comply with the rules of trend trading, and avoid trading against the trend.
## Risk Analysis
1. The fulcrum may fail and you need to pay attention to the breakthrough of the fulcrum.
2. It is necessary to prevent the stop loss tracking from being unfavorable and aggravating losses.
3. Transaction fees will also affect final returns.
## Optimization direction
1. You can test different parameters, such as time period parameters, trading direction parameters, etc., to optimize strategies.
2. Can be combined with other indicators to determine the trend and avoid false breakthroughs.
3. A stop-loss mechanism can be added to control single losses.
## Summarize
This strategy integrates classic technical analysis methods and trend trading strategies, uses the fulcrum area to determine the timing of market entry, and adopts the principle of buying high and selling low, which can effectively control trading risks and is worthy of real-time verification and optimization.
||
