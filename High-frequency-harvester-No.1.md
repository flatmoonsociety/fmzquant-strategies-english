...
The code itself is very well commented, so take it away if you know the stuff.
> Strategy Arguments
...
|----|----|----|
|DicAmount|0.6,1.5,1.8,1.9|Transaction Volume|
|DicBuyOffset|1.5,2.5,4.5,8|Buy Distance|
|DicSellOffset|1,1.8,2.5,4|Sell order distance|
|DicResetDiff|0.1,0.3,0.3,0.4|Cancellation Difference|
|DicStep|9,12,17,25|Increment step size|
|DicSleep|1,2,3,5|Waiting period|
|SleepPeriod|3000|Polling Period|
...
|----|----|----|
|Turn on/off order tracking|__button__|Turn on/off order tracking|
