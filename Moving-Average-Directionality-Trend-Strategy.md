...
## Strategy Principle
This strategy determines the long-term trend direction of the market by judging the direction adjustments of multiple moving averages, and performs corresponding long or short operations.
Main transaction logic:
1. Calculate multiple sets of moving averages with different periods, such as 5th, 20th, 50th, etc.
2. Compare the direction and trend of each moving average to determine whether there is a consistent adjustment direction.
3. When all the moving averages adjust upward, it is judged to be bullish in the long term; when all the moving averages adjust downward, it is judged to be bearish in the long term.
4. In the event of a bullish signal, a long position will be established if the price breaks through the downward stop loss line.
5. In the event of a bearish signal, a short position will be established if the price breaks through the upward stop loss line.
6. Set retracement stops to control risk
This strategy emphasizes judging the trend of the long-term trend and trading only after the trend is confirmed to control non-systematic risks.
## Strategic Advantages
- Multiple moving average combinations to determine long-term trends
- Add positions when the stop loss line is exceeded and follow the trend
- Retracement stop loss strategy to control risk
## Strategy Risk
- The moving average indicator itself lags the price
- Improper trend judgment may lead to continued losses
- Opportunities cannot be exploited by simply going long or short
## Summarize
This strategy emphasizes judging the long-term trend through the moving average trend to reduce non-systematic risks. But the accuracy of judgment and optimization of stop loss strategy are the key.
