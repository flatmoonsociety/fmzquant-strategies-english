...
## Strategy Principle
This strategy is based on trading in the form of high and low points of the same level on the K-line. When a double bottom or double top pattern appears on the weekly K-line, it is used as a trigger condition for trading signals.
The specific transaction logic is:
1. Determine whether the highest price of the current K line or the previous K line is equal to the highest price of the previous two K lines
2. Determine whether the lowest price of the current K line or the previous K line is equal to the lowest price of the previous two K lines.
3. When a double bottom pattern appears, go long when the price breaks through the low point.
4. When a double top pattern appears, go short when the price breaks through the high point.
5. The stop-loss point is set near the breakthrough point, and the take-profit point is the ATR indicator value multiplied by the coefficient.
This strategy attempts to capture the trend movement opportunity of price after breaking through the high and low points of the same level. Control risk with stop-loss and take-profit strategies.
## Strategic Advantages
- It is easy to identify the high and low levels at the same level, and the breakthrough signal is clear
- ATR take profit method can dynamically track the trend
- Simple and clear rules, controllable risks
## Strategy Risk
- The formation of high and low at the same level is relatively rare
- If the stop loss point is too close, there is a risk of being stopped.
- Need to pay attention to the setting of ATR parameters
## Summarize
This strategy trades trends by capturing opportunities for high-low breakouts at the same level. However, attention needs to be paid to the setting of stop-loss and take-profit strategies, as well as the issue of transaction frequency.
