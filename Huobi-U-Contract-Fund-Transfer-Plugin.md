...
|----|----|----|
|typeIndex|0|Transfer type: Transfer between parent and child accounts|Transfer from the same account to different accounts|
|subuid||Sub-account UID|
|asset|USDT|Transfer currency|
|from_margin_account|USDT|Margin account transferred out|
|to_margin_account|USDT|Margin account transferred to|
|amount|10000|Transfer amount|
|direct|0|Account transfer direction: mother to child|child to mother|
