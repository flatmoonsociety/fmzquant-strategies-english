...
EMA100 and NUPL Relative Unrealized Profit Quantitative Trading Strategy-EMA100-and-NUPL-Relative-Unrealized-Profit-Quantitative-Trading-Strategy
> Author
...
#### Strategy Principle
1. Calculate the 100-period EMA as the main trend judgment indicator
2. Use NUPL and relative unrealized profit as auxiliary indicators to confirm the strength and sustainability of the trend
3. When the price crosses above/under EMA100, a long/short signal is generated when NUPL and relative unrealized profit are positive/negative at the same time.
4. Use a fixed position of 10% and set a stop loss of 10% to control risks.
5. When holding a long position, if the price falls below the stop loss price, the long position will be closed; when holding a short position, if the price rises below the stop loss price, the short position will be closed
#### Advantage Analysis
1. Simple and easy to understand: The strategy has clear logic, uses common technical indicators, and is easy to understand and implement.
2. Trend following: Capture the main trend through EMA100, suitable for use in trending markets
3. Risk control: Setting fixed positions and stop losses can effectively control risks
4. Highly adaptable: This strategy can be applied to different markets and trading objects
#### Risk Analysis
1. False signals: In a volatile market, frequent price crossings with EMA100 may generate more false signals, leading to losses.
2. Hysteresis: As a lagging indicator, EMA may react slowly when the trend turns and miss the best entry opportunity.
3. Parameter optimization: Strategy parameters (such as EMA cycle, position size, stop loss ratio) need to be optimized according to different markets. Inappropriate parameters may lead to poor strategy effects.
#### Optimization direction
1. Parameter optimization: Optimize parameters such as EMA cycle, position size, stop loss ratio, etc. to improve strategy performance
2. Filter signals: Add other technical indicators or market sentiment indicators to filter out false signals
3. Dynamic position management: dynamically adjust positions based on market volatility, account profit and loss and other factors to increase returns and control risks
4. Long-short combination: hold long and short positions at the same time to hedge market risks and improve strategy stability
#### Summary
This trading strategy generates trading signals through three indicators: EMA100, NUPL and relative unrealized profit. It has the advantages of clear logic, controllable risk, and strong adaptability. There are also risks such as false signals, hysteresis and parameter optimization. In the future, strategies can be optimized and improved through parameter optimization, signal filtering, dynamic position management, and long-short combinations.
|| 
