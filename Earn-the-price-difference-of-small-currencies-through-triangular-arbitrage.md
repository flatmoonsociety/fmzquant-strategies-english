...
Earn the price difference of small currencies through triangular arbitrage
> Author
...
|pricePrecisions|1,1,1|Price retains decimals|
|amountPrecisions|1,1,1|Amount is kept in decimals|
|runMode|0|Run mode: test|buy only|sell only|buy and sell|
|placePriceRatio|0.8|Order price ratio|
|cancelPriceRatio|0.2|Cancel price ratio|
|minTakerAmount|true|Minimum amount for single arbitrage|
|maxTakerAmount|true|Maximum amount of single arbitrage|
|buyMaxTakerAmount|1000|Maximum buy order amount|
|sellMaxTakerAmount|1000|Maximum sell order quantity|
|restoreData|false|Rearchive|
