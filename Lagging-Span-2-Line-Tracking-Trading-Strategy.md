...
### Strategy Principles
This strategy mainly judges the movement of the Lagging Span 2 line in the indicator Ichimoku cloud. The Lagging Span 2 line is a smooth moving average based on price, and its sensitivity can be adjusted through the smoothing parameter. When the price breaks through the Lagging Span 2 line from top to bottom, go short; when the price breaks through the Lagging Span 2 line from bottom to top, go long.
Specifically, the strategy calculates the Lagging Span 2 line through the Donchian function. Then make a displacement offset to the line to get the final trading signal line. When the price breaks through the signal line, it is judged as a turning point in the price trend, and you can go long or short at this time.
When entering the market, the strategy also sets take-profit and stop-loss points. When going long, set the take-profit and stop-loss for long orders; when going short, set the take-profit and stop-loss for short orders.
### Advantage Analysis
The main advantages of this strategy are:
1. Use the Lagging Span 2 line in the Ichimoku cloud indicator to determine the trend. This line has good smoothness and avoids false breakthroughs.
2. The long and short signals are relatively clear and easy to judge.
3. Set up stop-profit and stop-loss at the same time, which can effectively control risks.
### Risk Analysis
The main risks of this strategy are:
1. The Lagging Span 2 line itself will also lag and may miss the entry point with a better trend. Smoothing parameter optimization can be adjusted appropriately.
2. Improper setting of stop-profit and stop-loss may cause losses to expand. The settings can be optimized according to the characteristics of different varieties.
3. Breakout trading inherently carries the risk of being caught by arbitrage. This can be avoided by setting trend filters or confirming breakouts.
### Optimization direction
This strategy can be optimized from the following aspects:
1. Adjust the smoothing parameters of the Lagging Span 2 line, optimize its sensitivity, and find a balance between discovering trend turning points and preventing false breakthroughs.
2. Set up take-profit and stop-loss respectively for long and short orders, and optimize the settings of take-profit and stop-loss to prevent excessive losses.
3. Add trend judgment conditions to avoid counter-trend trading. For example, combined with other indicators to determine the overall trend direction.
4. Add confirmation mechanism. Do not enter the market directly when the first breakthrough occurs, but wait for the confirmation signal of another pullback breakthrough.
### Summarize
The overall strategy is relatively simple and practical. Determine the price trend turning point based on the Lagging Span 2 line of the Ichimoku cloud indicator. At the same time, set a stop-profit and stop-loss to control risks. This strategy has a large space for optimization and can be adjusted from many aspects. It can not only obtain better entry opportunities, but also further control risks, thereby achieving better strategic effects.
||
