...
Since HTTPServer itself has some pitfalls, consider using ThreadingHTTPServer instead.
Reference: https://docs.python.org/3.7/library/http.server.html
Requires Python 3.7 version.
Information about HTTPServer issues:
...
|----|----|----|
|AccessKey|$$$__enc__$$$|AccessKey key|
