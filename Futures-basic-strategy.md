...
|cost|false|cost|
|stopProfit|false|Stop Profit|
|stopProfitPriceDifference|30|Stop Profit Price Difference|
|stopLoss|false|Stop Loss|
|stopLossPriceDifference|10|Stop Loss Difference|
|advanced|false|Show advanced settings|
|openRange|5|The price range that can open a position|
|closeRange|5|The price range that can close the position|
|openingTime|300000|Opening time (ms)|
|endTime|180000|Transaction end time (ms)|
|lingerTime|300000|Linger time (ms)|
|lingerLossRatio|30|Lingering stop loss ratio (%)|
|lingerLossPriceDifference|5|LingerLossPriceDifference|
...
|changeStopProfit|false|Change stop profit level|
