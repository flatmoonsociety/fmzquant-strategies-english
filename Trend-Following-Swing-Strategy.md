...
Trend following shock strategy, trailing take profit (take profit if there is a specified amount of shrinkage after profit)
> Strategy Arguments
...
|RatioUp|0.8|Reference point for rising selling (short selling)|
|RatioDown|0.8|Reference point for buying when falling (long)|
|UpWeightingVal|50|The number of points to open a long position when rising (relative to the highest decline)|
|DownWeightingVal|50|The number of points to open a short position when falling (relative to the highest increase)|
|StopProfitThreshold|0.9|Take profit coefficient (0-1)|
|EMA_Slow|30|EMA slow line period|
|EMA_Fast|7|EMA Fast Cycle|
|EnableGoingShort|true|Allow short selling|
