...
CoinPark Exchange General Protocol-627-1600-Update-SSL verification turned off
> Author

grass
> Strategy Description

## CoinPark Universal Protocol Python2 version
Purpose: BotVs can be made to support coinpark.cc exchange
Code public address: https://www.fmz.com/strategy/101399
Running address
http://127.0.0.1:6667
### 1. Run the plug-in on the server where the host is located
Just run it in the background on the server where the host that saved the file uploaded is located:
nohup python coinpark.py &
The port can also be specified at runtime:
python coinpark.py 8866
It can also be used as an ordinary robot to run on the simulation disk at no charge.
### 2. Configure the exchange on the FMZ website
The exchange configuration is as follows:
![iamge](https://dn-filebox.qbox.me/c1456599386e597f2966f67b49c7102bab857fef.png)
Since the account has no assets, detailed testing has not been conducted. Welcome to report bugs.
Updated at 2018.6.26 15:57, bug fixed
