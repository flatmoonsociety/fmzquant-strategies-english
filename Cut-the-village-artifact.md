...
|----|----|----|
|a|0.002|Minimum order amount for a single transaction, how many BTC|
|k|11|Risk coefficient k, the recommended value is 10-50. The smaller the value, the higher the risk and the greater the return|
|g2|100|Leverage multiple|
