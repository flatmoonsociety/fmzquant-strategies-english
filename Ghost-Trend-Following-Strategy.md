...
|tickInterval|3000|Tour interval (milliseconds)|
|orderValue|50|Order value (%)|
|bfCount|168|Number of nodes|
|isFlag|false|Inversion signal|
|stopSurplus|3|Percentage reduction|
|stopSurplusCount|50|Surplus position amount (%)|
