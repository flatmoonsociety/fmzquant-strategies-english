...
|----|----|----|
|Spread|50|Pending order price interval|
|OrderSize|0.1|Each order size|
|SpreadTimes|true|Order size increment multiple|
|TotalBuy|3|Total purchase volume|
|TotalSell|3|Total sales volume|
|Interval|300|Sleep time (ms)|
|fee|0.25|handling fee|
