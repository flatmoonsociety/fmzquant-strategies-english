...
Moving-Average-Crossover-Strategy-with-Stop-Loss-and-Take-Profit based on moving average crossover
> Author
...
![IMG](assets/images/a1cdbed6c6aeb874b2d54b6bdf541112ab1c9d4c51f010ef5320aa71e2b5409a.png)
[trans]

## Overview
This strategy realizes automatic trading by calculating moving averages of different periods and setting stop-loss and profit-stop points. Go long when the short-period moving average crosses the long-period moving average; go short when the short-period moving average crosses below the long-period moving average. Set stop loss and take profit points at the same time to control risk.
## Strategy Principle
This strategy is based on the moving average crossover principle. It calculates both the 9-day simple moving average and the 55-day simple moving average. When the 9-day moving average crosses the 55-day moving average, it means that the short-term trend reverses to upward, and you will go long at this time; when the 9-day moving average crosses below the 55-day moving average, it means that the short-term trend reverses to decline, and you will go short at this time.
At the same time, this strategy uses the ATR indicator to set stop loss and take profit points. The ATR indicator can measure the extent of market fluctuations. The stop-loss point is set to the closing price minus the ATR value, so that a reasonable stop-loss can be set according to market volatility; the stop-profit point is set using the risk-return ratio, and here it is set to a risk-reward ratio of 2, that is, take-profit = closing price + 2 * ATR value.
## Strategic Advantages
This is a very simple and practical short-term trading strategy, which has the following advantages:
1. The principle of moving average crossover is simple and easy to understand and master;
2. Combining stop loss and take profit at the same time can effectively control risks and enhance practicality;
3. Moving average parameters can be flexibly adjusted to adapt to different market environments;
4. ATR stop loss can set the stop loss point according to market volatility, which is more intelligent;
5. The risk-reward ratio setting can be adjusted according to personal risk preference.
## Strategy Risk
There are also some risks with this strategy:
1. The moving average crossover signal may have a false breakthrough, causing erroneous transactions;
2. Improper stop loss or stop profit setting may increase losses or reduce profits;
3. Improper setting of moving average parameters will lead to excessive trading frequency or signal lag;
4. Improper setting of ATR parameters will also make the stop loss point too close or too far.
These risks can be reduced by optimizing parameters, strict stop loss, and reasonable position management.
## Strategy optimization
This strategy can be further optimized:
1. Use optimization tools to find the best moving average parameter combination;
2. Add other indicators to filter moving average crossover signals to avoid false breakthroughs;
3. Try other types of moving averages, such as exponential moving averages, etc.;
4. You can consider optimizing the ATR parameters to make stop loss and profit more intelligent.
## Summarize
The overall idea of ​​this strategy is clear and easy to implement, especially suitable for beginners to master. As a basic short-term trading strategy, it has the advantages of simple operation and easy optimization. If used with COMPLETE or other frameworks, the strategy can be further strengthened and made into a practical enough quantitative trading system.
||
