...
Bybit-algorithm connector-VWAP-BTC
> Author
...
This is very annoying, isn't it...
 ...
 It's not a great strategy in itself... 
Everyone, feel free to play~
 Don’t spend money to buy my spicy chicken source code~
 Let’s use it directly!! Let’s go!! 
Just an advertisement~
 For more tips on losing money, please follow the public account "Lengdouzi's Quantitative Diary"
 WX: wangxiaoba 
 (●'◡'●)
...
|long_qty|true|One time long USD|
|short_qty|true|Single short USD|
...
|GG|3|Leverage multiple (2x-7x is appropriate, the greater the leverage, the greater the risk)|
