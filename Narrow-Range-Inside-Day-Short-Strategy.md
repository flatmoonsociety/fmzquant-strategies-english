...
Narrow-Range-Inside-Day-Short-Strategy
> Author
...
## Strategy Principle
This strategy combines narrow range (NR7) and mileage to identify shorting opportunities.
The transaction logic is:
1. Identify NR7, that is, the range of the highest price and lowest price is the narrowest in the past 7 days
2. Identify the mileage, that is, the highest price is lower than the previous day, and the lowest price is higher than the previous day
3. When NR7 and mileage appear on the same day, and the closing price is lower than the opening price
4. When the direction of the simple moving average is downward, go short.
5. When the closing price is lower than the opening price again on the next trading day, close the position
This strategy makes full use of narrow range and mileage to indicate consolidation. Combining moving average judgment and closing price position can improve the efficiency of short selling.
## Strategic Advantages
- Narrow width and mileage judgment reversal timing
- Condition combination to avoid false signals
- Optional long and short operations
## Strategy Risk
- NR7 and mileage combinations are rare
-Need to optimize moving average parameters
- Only short selling cannot take advantage of long opportunities
## Summarize
This strategy shorts through efficient reversal identification and verification. However, the trading frequency is low and the effect of the strategy needs to be evaluated. Parameter optimization and scalable strategies for long and short trading.
