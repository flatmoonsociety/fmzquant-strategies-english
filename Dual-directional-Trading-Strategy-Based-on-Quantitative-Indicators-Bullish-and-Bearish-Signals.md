...
Dual-directional-Trading-Strategy-Based-on-Quantitative-Indicators-Bullish-and-Bearish-Signals
> Author
...
![IMG](assets/images/996374778317f306b5b2c37927a0bbbcd3be3cc0ad5c5ca43f3c06e50d857f14.png)
[trans]

### Overview
This strategy is a two-way trading strategy based on the long and short signals generated by the Donchain price channel indicator and the quantitative indicator OBV oscillator. It uses price channel indicators to determine price breakthroughs and pullbacks, and combines quantitative indicators to determine the strength of long and short positions to generate trading signals.
### Strategy Principles
1. Use the Donchain price channel indicator to determine the upper and lower price channels. The upper price channel is calculated from the highest price, and the lower price channel is calculated from the lowest price.
2. Use the OBV quantitative indicator and EMA indicator to construct the OBV oscillator to determine the strength of long and short positions. When the oscillator is greater than 0, it means that the strength of the bulls is greater than the strength of the bears, and vice versa when it is less than 0.
3. When the price breaks through the upper channel and the oscillator is greater than 0, a long signal is generated; when the price breaks through the lower channel and the oscillator is less than 0, a short signal is generated.
4. When the price pulls back to the lower channel, close the position and go long; when the price pulls back to the upper channel, close the position and go short.
### Strategic Advantages
1. Use price channels to determine trends and avoid being misled by volatile market conditions.
2. Use quantitative indicators to judge long and short forces to ensure that the trading direction is consistent with market forces.
3. Using two-way trading, you can make profits whether the market rises or falls.
4. Set up stop-loss and stop-profit strategies to effectively control risks.
### Strategy Risk
1. Improper setting of price channel parameters may cause the channel to be too loose or too narrow, resulting in missed trading opportunities or false signals.
2. Improper setting of indicator parameters may also cause signals to lag or advance.
3. Rapid and abnormal market conditions caused by emergencies may trigger stop-loss orders and lead to losses.
4. Two-way trading requires managing long and short positions at the same time, which makes the operation difficult.
### Strategy optimization direction
1. Optimize the price channel parameters and find the best parameter combination.
2. The OBV oscillator parameters must also be tested and optimized to ensure timely and accurate judgment of long and short forces.
3. You can consider combining other indicators such as MACD, KD, etc. to judge market trends and improve signal accuracy.
4. You can test the effects of different stop loss methods, such as trailing stop loss, percentage stop loss, etc.
5. You can test different varieties to find the ones that are most suitable for the operation of the strategy.
### Summarize
Overall, this strategy is a two-way trading strategy that combines price trends and quantitative indicators to determine market trends and long and short forces. The strategy is clear and easy to understand. The optimization space is also relatively large, and the stability and profitability of the strategy can continue to be improved through parameter optimization and indicator combination.
||
