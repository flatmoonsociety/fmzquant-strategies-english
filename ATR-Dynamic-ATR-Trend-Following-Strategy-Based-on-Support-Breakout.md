...
Dynamic ATR Trend Following Strategy Based on Support Breakout-Dynamic-ATR-Trend-Following-Strategy-Based-on-Support-Breakout
> Author
...
![IMG](assets/images/82851d6cff920e5b50d3f96ff459d5865c6525493655cad92e2e5c78172a8f01.png)

[trans]
#### Overview
This is a dynamic ATR trend following strategy based on support breakouts. This strategy comprehensively uses the EMA moving average system, ATR volatility indicator and smart money concept (SMC) to capture market trends. The strategy achieves good risk management by dynamically calculating position sizes and stop-loss and take-profit positions.
#### Strategy Principle
The strategy is mainly built on the following core components:
1. Use the 50 and 200 period EMA moving average systems to confirm the market trend direction
...
4. Automatically calculate the opening amount based on the account risk percentage
5. Judge whether the market is in a consolidation state by observing the fluctuation range of nearly 20 K lines
#### Strategic Advantages
1. Perfect risk management, ensuring that the risk of each transaction is controllable through dynamic calculation
2. The trend judgment system is reliable and avoids trading in consolidation markets.
3. The stop-loss and stop-profit settings are reasonable, and the risk-return ratio is 1:3.
...
#### Strategy Risk
1. The EMA indicator has hysteresis, which may cause a delay in entry timing.
2. False signals may be triggered in violently volatile markets
3. The strategy relies on trend continuity and may perform poorly in volatile markets.
4. The stop loss position is wider and you may suffer larger losses in some cases.
#### Strategy optimization direction
1. Volume-price relationship analysis can be introduced to improve the accuracy of trend judgment.
...
5. Optimize stop loss methods and consider using trailing stop loss
#### Summary
This strategy is a relatively complete trend tracking system that improves the stability of transactions through reasonable risk management and multiple signal confirmations. Although there is a certain lag, it is overall a reliable trading system. It is recommended to conduct sufficient backtest verification before using it in real trading, and optimize parameters according to specific trading varieties and market environment.
|| 
