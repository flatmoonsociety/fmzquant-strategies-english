...
BTC trading strategy based on Ichimoku moving average system Ichimoku-Kinko-Hyo-Based-BTC-Trading-Strategy
> Author
...
![IMG](assets/images/616c40b39e54d507698e07857fa90d196da5dd8dffd751c06205b801b85a562b.png)
 [trans]

## Overview
The name of this strategy is "Ichimoku Kinko Hyo Strategy", which is the Ichimoku Moving Average system strategy. It is a BTC trading strategy based on the Ichimoku moving average and combined with other technical indicators.
## Strategy Principle
This strategy is mainly based on the Ichimoku moving average system, which is a trend trading strategy system that integrates multiple technical indicators. It mainly includes the following indicators:
Base line (Kijun Sen): represents the direction of the market trend and is the midpoint of the high and low points of the past 26 days, which can be used as a support and resistance line. When the closing price breaks above the baseline, buy and sell signals are generated.
Conversion Line (Tenkan Sen): Represents the momentum of the stock price. It is the midpoint of the high and low points of the past 9 days and can be used to determine the timing of buying and selling.
Future SPAN A: represents the mid-term line of the Ichimoku Moving Average, which is the average of the baseline and conversion lines and can be used as the warning line of the Ichimoku Moving Average.
Future SPAN B: represents the long-term trend line, which is the midpoint of the past 52 days. It can form a cloud chart to determine the long-term and short-term trends.
In addition, this strategy also combines the RSI indicator to send trading signals in overbought and oversold areas.
A buy signal is generated when the closing price breaks above the baseline and is above the cloud; a sell signal is generated when the closing price falls below the baseline and is below the cloud.
## Strategic Advantages
1. The Ichimoku moving average system accurately determines the trend and has a high winning rate.
2. Combine multiple indicators to avoid missing opportunities
3. RSI indicator can effectively determine reversal points
4. Cloud chart visually displays long-term and short-term trends
## Risk Analysis
1. The Ichimoku moving average system lags behind and needs to be judged in conjunction with other indicators.
2. The trending market has good performance, but the shock market has average performance.
3. RSI parameter settings need to be adjusted according to the market
4. The structure of the cloud chart is complex and requires skillful use.
It can be optimized by adjusting the Ichimoku moving average parameters or combining it with more technical indicators.
## Optimization direction
1. Optimize the parameters of the Ichimoku moving average so that it can judge the trend faster
2. Add indicators such as moving averages to improve signal accuracy
3. Adjust RSI parameter settings according to different markets
4. You can consider adding a stop-loss mechanism to control risks
## Summarize
This strategy comprehensively uses multiple indicators such as Ichimoku moving average and RSI to judge the trend, and is more accurate in judging the upward trend. However, the Ichimoku moving average system lags behind and cannot judge shocks, which is the main risk of this strategy. By optimizing parameter settings or adding other indicators, this shortcoming can be well compensated and the strategy can be made more stable and reliable.
||
