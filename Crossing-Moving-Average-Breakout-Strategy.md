...
Crossing-Moving-Average-Breakout-Strategy Based on Moving Average Crossover Breakout Strategy
> Author
...
### Strategy Principles
1. Calculate three moving averages: long-term, medium-term and short-term. Users can set the cycle by themselves. The default is the 20th, 10th, and 5th.
2. Compare the directions of the three moving averages. When the short-term moving average crosses the medium-term and the medium-term moves above the long-term, it is judged to be a bull market. When the short-term moving average falls below the mid-term, and when the mid-term moves below the long-term, it is judged to be a short market.
3. In the long market, if the price breaks through the highest price in the recent N K lines, go long; in the short market, if the price breaks through the lowest price in the recent N K lines, go short. N is also a user-defined parameter.
4. After entering the position, set stop loss and take profit. The stop loss in the long market is the lowest price within the recent N K lines, and the stop loss in the short market is the highest price within the recent N K lines.
### Advantage Analysis
This strategy combines moving average indicators and K-line graphics to better judge market trends. At the same time, reasonable stop-loss and stop-profit settings are helpful to avoid larger losses.
Compared with indicators such as a single moving average, this strategy uses three moving averages to judge market trends with higher reliability. At the same time, it is a common breakthrough strategy to enter a position by breaking through the highest or lowest price of the recent N K-lines. Overall, the strategy is clear and easy to implement.
### Risk Analysis
The main possible risks of this strategy are:
1. The probability of misjudgment of the direction of the three moving averages. If the short- and medium-term moving averages create false signals, unnecessary losses may result.
2. If the timing of breakthrough entry is not chosen properly, it is easy to get trapped. The timing of entry should be appropriately optimized.
3. The stop loss distance is set too small. Expanding the stop loss distance will help give the price more running room.
### Optimization direction
This strategy can be optimized from the following directions:
1. Add other indicator filters to ensure the reliability of moving average signals. For example, long and short judgments to increase trading volume.
2. Optimize the period parameters of the moving average to better adapt to different varieties.
3. Add machine learning algorithms to realize automatic optimization of parameters.
4. Test the effectiveness of the strategy on high-frequency data.
### Summarize
This strategy is generally simple and general, with clear ideas and strong practical feasibility. As an example of a moving average crossover system, it is a common choice for beginners. Through appropriate optimization, the system can be applied to a wider range of varieties and time periods, thereby obtaining stable returns.
||
