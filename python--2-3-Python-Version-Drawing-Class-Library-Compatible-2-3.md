...
python version-line drawing class library-compatible 2-3-Python-Version-Drawing-Class-Library-Compatible-2-3
> Author

Inventor Quantification-Little Dream
> Strategy Description

Simplified the logic of drawing lines in the strategy chart, you can directly call the encapsulated functions
* Support drawing multiple lines
* Support K-line chart
* Support flag small icon
* You can also add support for more graphics
The function is equivalent to the JS version
Ported to JS version line drawing class library
### If you have any questions, please contact Xiaoxiaomeng 359706687
