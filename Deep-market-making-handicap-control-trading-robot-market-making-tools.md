...
The general strategy for running on exchanges is to obtain the current price and at the same time place buy and sell orders to increase depth. You can copy other market trends and refer to other trends.
