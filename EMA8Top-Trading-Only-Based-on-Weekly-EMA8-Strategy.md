...
![IMG](assets/images/902028ae7f21123f12a8f16a00b9805ea2a256fa01bd5a6eb17a0ce62fb75331.png)
[trans]

## Overview
This strategy is an adaptation of the EMA8 setup from famous Brazilian crypto YouTuber Augusto Backes. This strategy aims to use the support of weekly EMA8 to conduct high-probability and high-risk-return transactions when the price appears in a specific form.
## Strategy Principle
- This strategy is suitable for daily cycles, using weekly EMA8 as support and long-term trend judgment standard
- When the daily K-line crosses above and closes above the weekly EMA8, a buy signal is generated. The daily K-line that triggers the buy signal must also form a specific pattern such as a engulfing pattern, a hammer pattern, or a shrinking and rising action.
- When the daily K-line crosses below and closes below the weekly EMA8, a sell closing signal is generated. The daily K-line that triggers the sell signal must also form a corresponding trap pattern, hammer pattern, or heavy volume falling action.
- Entry signals and position closing signals are executed at the close of the K-line, without intermediate stop loss, full position trading
This strategy effectively uses EMA as support, reasonably controls the position frequency, captures reliable breakthroughs in short- and medium-term prices in large-level trends, and achieves the trading goal of a high risk-to-return ratio.

## Advantage Analysis
- Use EMA to assist in determining large-level trends and midline support to improve trading reliability
- Only trade near key points to reduce the frequency of invalid transactions and obtain a higher winning rate
- Accurate trading points, clear signals, and high risk-return ratio
- Suitable for mid-term investors, no frequent operations required

## Risk Analysis
- Cross-margin trading carries high risks. When unexpected market conditions occur, you may face large losses.
- Position frequency is low, requiring sufficient psychological endurance and financial strength
- Compared with trend trading, the profit potential is limited and suitable for short- and medium-term operations.
It can be optimized through the following points:
- Add a position management module, such as setting a position percentage upper limit based on volatility or capital size
- Added stop loss module to further control single loss
- Find more reasonable trading filters and closing conditions to improve the success rate of profitable transactions
## Summarize
This strategy is generally a very practical short- and medium-term trading strategy. It uses key technical indicators to assist judgment and capture reliable short- and medium-term trading opportunities in large-level trends. The strategy logic is concise and clear, the implementation requirements are not high, and it is very suitable for medium and long-term investors. If combined with reasonable position and risk management mechanisms, you can get very ideal investment returns.
