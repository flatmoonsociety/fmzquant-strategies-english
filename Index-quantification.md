...
|----|----|----|
|junxianx|true|mean value|
|junxiant|true|averaging days|
|rise_fall|0|The closing price of the previous hour or day before the current time: Please select |hour|day|
|rise_warn|true|Rise warning value|
|fall_warn|true|Fall warning value|
|macdwarn|8000|macd reminder value|
|macdzhouqi|0|macd cycle: 1 minute|5 minutes|15 minutes|30 minutes|1 hour|one day|
|kdj1|9|Period 1 value|
|kdj2|3|Period 2 value|
|kdj3|3|Period 3 value|
|kdjkwarn|true|k reminder value|
|kdjdwarn|true|d reminder value|
|kdjjwarn|true|j reminder value|
|kdjtp|0|Period moving average type: 1 minute|5 minutes|15 minutes|30 minutes|1 hour|One day|
