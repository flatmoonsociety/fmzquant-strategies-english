...
This strategy observes the continuation of the moving average momentum and goes long during the continuous rising stage to achieve continuous chasing operations. This strategy belongs to the trend following strategy and is designed to continue to capture the upward momentum of the bull market.
Strategy principle:
1. Calculate a weighted moving average to reflect price momentum.
2. When the weighted moving average rises for 5 consecutive days, enter the market long.
3. When the weighted moving average falls for 4 consecutive days, exit the market with a long order.
4. Judge the long-lasting trend by the number of days it continues to rise to avoid being reversed by short-term adjustments.
5. Set a maximum stop loss to control the maximum loss in a single day.
Advantages of this strategy:
1. Track the continuous rising momentum and capture market hot spots for a long time.
2. Judging by the number of consecutive days is helpful to skip short-term adjustment shocks.
3. Maximum stop loss settings limit tail risk.
Risks of this strategy:
1. Unable to limit correction losses after a sustained rise.
2. If there is a deep adjustment, it may cause large losses.
3. If the stop loss setting is too loose, there is also the risk of excessive losses.
In short, this strategy chases the rise after judging that it continues to rise, and can effectively capture market hot spots. However, we need to be alert to the risk of deep corrections, adjust stop loss parameters appropriately, and do adequate risk management.
||
