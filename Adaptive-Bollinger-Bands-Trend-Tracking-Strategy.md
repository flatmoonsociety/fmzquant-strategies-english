...
Two-way adaptive Bollinger Bands trend tracking strategy-Adaptive-Bollinger-Bands-Trend-Tracking-Strategy
> Author
...
## Strategy Principle
1. Calculate the Bollinger middle track, upper track and lower track based on a certain period
2. If the price breaks through the upper track, you will go long and follow it; if it breaks through the lower track, you will go short and follow it.
3. Use market orders to quickly enter the market
4. Set stop loss position and take profit position for position management
## Advantage Analysis
1. Adaptive Bollinger Bands indicator is sensitive to market fluctuations and can quickly determine trend changes.
2. Use market orders to quickly enter the market and reduce the risk of slippage.
3. Automatically stop losses and profits, strictly control risks, and lock in profits
## Risk Analysis
1. Bollinger Bands themselves have hysteresis and cannot completely avoid false breakthroughs.
2. The transaction price cannot be controlled by using market orders.
3. Stop loss and take profit levels need to be set appropriately
## Optimization direction
1. Adjust the parameters of Bollinger Bands and optimize the sensitivity of judging trends.
2. Add indicators such as trading volume or MACD to filter out false breakthroughs
3. Optimize the settings of stop loss and take profit levels
## Summary
This strategy makes full use of the advantages of Bollinger Bands in judging the direction and changes of trends, and combines it with market orders that quickly exit for two-way tracking to obtain excess returns while controlling risks. By further optimizing Bollinger Band parameters, adding auxiliary filtering indicators, adjusting stop loss and take profit logic, etc., better strategy performance can be achieved. The strategy is clear and easy to implement, and it is an efficient and reliable trend following trading strategy.
||
