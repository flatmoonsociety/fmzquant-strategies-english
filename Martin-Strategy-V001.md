...
|----|----|----|
|DF|0,1,2,3,4,5,6,7|The proportion of each decline, converted from string to array. |
|JYD|$$$__enc__$$$BTC|The trading pair you bought|
|startNum|true|The initial purchase quantity in USTD|
