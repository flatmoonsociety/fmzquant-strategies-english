...
Updated on 6.24, 4 night trading time types have been improved, and the night trading time in the early morning of Saturday is included in the trading period.
Based on the version provided by the original zero, the function of placing limit orders and flat price orders has been added to facilitate order payment.
...
|----|----|----|
|Interval|500|Failure retry interval (milliseconds)|
|SlidePrice|false|Sliding price of order (yuan)|
|nightType|true|Product night sales situation|
|holidaysList|5.1,5.2|Holidays|
