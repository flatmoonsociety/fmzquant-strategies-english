...
Yongying Quantification-1
> Strategy Description

* Based on some characteristics of altcoins, based on subjective judgment, you can definitely buy at certain prices and sell at certain prices.
...
* Thanks to Zinan’s mid_class for the idea support, I learned and wrote this strategy at station B to practice.
...
|AMOUNT_PRECISION|{"BTC_USDT":4, "LTC_USDT":6}|Transaction quantity precision list|
|HANDS|{"BTC_USDT":4, "LTC_USDT":6}|How many lots are traded each time|
