...
![IMG](assets/images/4794381f0423ca769311ba63c0ce16033a24dd7253f89d3b3ea52e87952e3696.png)

[trans]
#### Overview
This strategy is a trading system that combines dual moving average trend judgment, ADX momentum filtering and adaptive risk management. The strategy uses the 50- and 200-period exponential moving averages (EMA) as the basis for trend judgment, momentum confirmation through ADX and DMI indicators, and dynamically adjusts stop loss and profit targets based on ATR.
#### Strategy Principle
The core logic of the strategy is divided into three parts:
1. Trend judgment: Use the position relationship between the 50 and 200 period EMA to determine the current trend direction. If EMA50 is above EMA200, it is an upward trend, and vice versa is a downward trend.
2. Momentum confirmation: Use ADX and DMI indicators to confirm the strength of the trend. It is required that ADX is greater than the set threshold (default 25), and DI+ is greater than DI- to confirm an upward trend, and vice versa to confirm a downward trend.
3. Entry timing: After confirming the trend, the intersection of price and EMA50 is used as a specific entry signal. Cross upward to go long and cross downward to go short.
#### Strategic Advantages
1. Multiple confirmation mechanism: Effectively reduce false signals through multiple confirmations of trends and momentum.
2. Adaptive risk management: Use ATR to dynamically adjust the stop loss position to make risk management more consistent with market fluctuation characteristics.
3. Risk-return ratio optimization: Through the preset risk-return ratio, ensure that the return expectation of each transaction is reasonable.
4. Visual support: The strategy provides a complete graphical display, including trend lines, stop-loss and take-profit positions, and trading signal marks.
#### Strategy Risk
1. Trend turning delay: Due to the use of longer period moving averages, there may be a certain delay when the trend turns.
2. Not applicable to volatile markets: In sideways volatile markets, frequent false signals may occur.
...
1. Market environment adaptation: You can add market environment judgment logic and dynamically adjust parameters under different fluctuation environments.
2. Signal filtering enhancement: Trading volume or other technical indicators can be introduced as auxiliary filtering conditions.
3. Stop loss optimization: You can consider using trailing stop loss or compound stop loss strategy to improve the flexibility of risk management.
4. Opening positions in batches: It can realize the batch entry and batch exit mechanism and optimize fund management.
#### Summary
This is a trend following strategy with a complete structure and clear logic. Through the combined use of multiple technical indicators, it achieves relatively reliable trading signal generation and risk control. The strategy is highly scalable and has large room for optimization. Through reasonable parameter adjustment and optimization measures, it can adapt to different market environments. ||
#### Overview
