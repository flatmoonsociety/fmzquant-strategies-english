...
# Two-way contract grid trading v1.0.2
> Function
Contract Grid Trading
At the same time, arbitrage the price difference by going short and long.
Since the two-way strategy has a very small chance of liquidation
* Judgment of buy order timeout
* Double investment
* Automatically follow orders
* Trend ordering (to be developed, paid version)
...
The benefits are obvious, no matter whether there is a big rise or a big fall, you can withstand it
> Maintenance
