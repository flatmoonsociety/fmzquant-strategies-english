...
This strategy uses a combination of moving averages, Bollinger Bands and RSI indicators to judge price trends and overbought and oversold phenomena to discover trading opportunities. This strategy brings together the advantages of multiple indicators and seeks to improve the accuracy of trading decisions.
Strategy principle:
1. Calculate the moving average and its Bollinger Bands to determine the medium and long-term price trend.
2. Calculate the RSI indicator to determine whether it has entered an overbought or oversold state.
3. When the price breaks through the lower Bollinger Band from bottom to top and the RSI crosses bullishly, go long.
4. When the price breaks through the upper Bollinger Band from top to bottom and the RSI crosses short, go short.
5. Set a stop loss line to control single losses.
Advantages of this strategy:
1. Multi-indicator combination verification can reduce the probability of wrong transactions.
2. The RSI indicator can supplement the shortcomings of the moving average system.
3. Moving average Bollinger Bands can identify breakthrough points.
Risks of this strategy:
1. Multi-index combination requires time-consuming parameter optimization.
2. There is a certain degree of overlap between RSI and Bollinger Bands.
3. Breakthrough transactions form a head effect and lead to a reversal.
In short, this strategy combines moving averages, Bollinger Bands and RSI indicators to identify reversal trading opportunities while judging trends. Combining indicators can improve the effect, but it is necessary to pay attention to parameter optimization and control risks.
||
