...
Encapsulates Bithumb’s ordersDetail interface
> Author

Inventor Quantification-Little Dream
> Strategy Description

In response to the needs of some users, when using bithumb, they want to query the order information of a certain ID.
Encapsulates this interface of the exchange: https://api.bithumb.com/info/order_detail
Only fully completed orders can be queried, orders in other statuses cannot be queried.
