...
Supertrend and EMA combination strategy-Supertrend-and-EMA-Combination-Strategy
> Author
...
![IMG](assets/images/d78c336c52ca3b8875a84ea712b72e1315574c0643f0314cb4f2018b8bd28c61.png)

[trans]
#### Overview
The Supertrend and EMA combination strategy is a trading strategy that combines the Supertrend indicator and multiple EMA indicators. This strategy uses the Supertrend indicator to determine the trend direction of the current market, and also uses the EMA indicator of different periods as the triggering condition for buying and selling signals. When the short-term EMA and the mid-term EMA cross, and the Supertrend indicator shows an upward trend, a buy signal is generated; when the short-term EMA and the mid-term EMA cross, and the Supertrend indicator shows a downward trend, a sell signal is generated.
#### Strategy Principle
The core principle of the Supertrend and EMA combination strategy is to use the characteristics of the Supertrend indicator and EMA indicator to capture market trend changes and price fluctuations. The Supertrend indicator determines the trend direction of the current market by comparing the current closing price with the upper and lower tracks of the previous period. When the closing price breaks through the upper band, it indicates that the market has entered an upward trend; when the closing price falls below the lower band, it indicates that the market has entered a downward trend. At the same time, this strategy uses four EMA indicators of different periods (20-day, 50-day, 100-day and 200-day) to generate buy and sell signals by comparing the intersection of short-term EMA and mid-term EMA. When the short-term EMA crosses above the mid-term EMA, it indicates that the market may have upward momentum, and combined with the upward trend of the Supertrend indicator, a buy signal is generated; when the short-term EMA crosses below the mid-term EMA, it indicates that the market may experience downward pressure, combined with the downward trend of the Supertrend indicator, a sell signal is generated.
#### Strategic Advantages
1. Strong trend tracking ability: Supertrend indicators can effectively capture market trend changes and help strategies to trade in compliance with market trends.
2. Multiple EMA confirmation: Using EMA indicators of different periods as trigger conditions for buying and selling signals can improve the reliability of signals and reduce the occurrence of false signals.
3. Risk control: By judging the trend of the Supertrend indicator, you can avoid trading in adverse market conditions and reduce risks.
4. Strong adaptability: This strategy can be applied to different markets and varieties, and has good adaptability and flexibility.
#### Strategy Risk
1. Parameter optimization risk: The parameter settings of the Supertrend indicator and EMA indicator have a great impact on the strategy performance. Inappropriate parameters may cause the strategy to fail.
2. Market fluctuation risk: When the market fluctuates violently, the short-term EMA and the mid-term EMA may cross frequently, causing the strategy to generate multiple false signals.
3. Trend turning risk: When the market trend turns, the Supertrend indicator may lag, causing the strategy to suffer losses at the early stage of the trend turning.
#### Strategy optimization direction
1. Parameter optimization: By optimizing the multiplier of the Supertrend indicator and the cycle of the EMA indicator, find the best parameter combination to improve the stability and profitability of the strategy.
2. Signal filtering: After the EMA cross signal is generated, the signal can be confirmed twice in combination with other technical indicators (such as RSI, MACD, etc.) to improve the reliability of the signal.
3. Stop loss and take profit: Introduce a reasonable stop loss and take profit mechanism to control the risk of a single transaction and improve the risk-return ratio of the strategy.
4. Multiple varieties and multiple cycles: Apply this strategy to different varieties and cycles to reduce overall risk through diversified investments.
#### Summary
The Supertrend and EMA combination strategy forms a complete trend following trading system by combining the Supertrend indicator with multiple EMA indicators. This strategy uses the Supertrend indicator to determine market trends, and at the same time generates buying and selling signals through the crossover of the EMA indicator. It has the advantages of strong trend tracking capabilities, reliable signal confirmation, and wide adaptability. However, the strategy also faces risks such as parameter optimization, market fluctuations and trend turning. It needs to be optimized and improved through parameter optimization, signal filtering, stop loss and take profit, and multiple varieties and multiple cycles to improve the robustness and profitability of the strategy.
|| 
