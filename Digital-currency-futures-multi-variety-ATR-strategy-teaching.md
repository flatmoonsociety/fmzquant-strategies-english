...
For multi-variety design, the parameters are designed as a JSON string:
```
var params = '[{
        "symbol" : "swap",
        "period" : 86400,
...
The strategy uses a template library: Digital Currency Futures Trading Library (Beta Version)
> Strategy Arguments
