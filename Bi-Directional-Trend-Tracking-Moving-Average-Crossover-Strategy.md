...
![IMG](assets/images/836cdc764b820043343694193f86339b2d0755d9d233d67b0c17fed70e55aff9.png)
[trans]

## Overview
This strategy implements a cross trading strategy that can automatically track price trends by calculating a two-way smoothed moving average and combining it with trend indicators. This strategy aims to track long-term trends and obtain greater profits in strong trends.
## Strategy Principle
1. Calculate the two-way smoothed moving average of price, including the average opening price and the average closing price.
2. Use the correlation coefficient and ATR indicator to calculate the price trend indicator. 
3. Combine the price trend indicator with the two-way moving average to obtain a comprehensive trend judgment.
4. Go long when a golden cross occurs between the opening price average line and closing price average line; close the position when a dead cross occurs.
5. At the same time, combined with the trend indicator, only open a long position when the trend indicator is also long at the same time, and only open a short position when the trend indicator is also short at the same time.
## Strategic Advantages
1. The two-way moving average tracks the price trend more smoothly and stably.
2. Combined with trend indicators, you can better judge the trend direction and avoid wrong transactions. 
3. Use golden crosses and dead crosses to determine specific trading opportunities to make it more clear.
4. You can freely choose the degree of smoothness through parameter adjustment to adapt to more market environments.
5. Multiple indicators verify each other, which can reduce false signals.
## Strategy Risk
1. The risk of missing a reversal at a trend turning point. This can be reduced by adjusting the moving average period.
2. The two-way moving average itself has a large lag and needs to be verified with trend indicators.
3. Improper moving average period may lead to excessive trading frequency or missing good trading opportunities.
4. It is necessary to repeatedly test the optimization parameters to adapt to different cycles and market environments.
## Strategy optimization direction
1. Test more types of moving average indicators.
2. Try other types of trend indicators. 
3. Optimize the parameters of moving averages and trend indicators.  
4. Try combining it with other indicators, such as volatility indicators.
5. Add a stop loss strategy.
## Summary
This strategy predicts price trends from multiple dimensions and can stably track long-term trends after parameter optimization. However, care needs to be taken to prevent over-optimization and testing fitting. Overall, this strategy achieves long-term trend tracking with lower risk and is worthy of further research and application.
||
