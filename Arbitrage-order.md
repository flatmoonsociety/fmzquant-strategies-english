...
|----|----|----|
|SYMBOL1|Go long on top|Trading pair 1|
|SYMBOL2|Go long on the downside |Trading pair 2|
|VALUE| cannot be less than the minimum opening value, which is the opening value of a single currency |Opening value|
