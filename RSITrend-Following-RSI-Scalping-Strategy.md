...
Trend-Following-RSI-Scalping-Strategy based on RSI
> Author
...
It may seem counterintuitive to construct a trend-following trading strategy based on the RSI, which is often considered a contrarian indicator. But proven through more than 200 backtests, this is a very interesting long-term strategy setup.

## Strategy Principle
This strategy assumes 30% of available funds are traded per order. A 0.1% trading fee is taken into account, which is in line with the base fees of Binance, the world’s largest cryptocurrency exchange.
- Enter signal: go long when RSI is greater than 70 and within the backtest window
- Exit signal: close the position when RSI is less than 55 or the closing price is greater than the take profit price
## Advantage Analysis
- Use the RSI indicator to identify trends and avoid missing signals in volatile markets
- Quota position management to effectively control single losses
- Suitable for medium and long-term holdings to avoid being knocked out by short-term fluctuations
## Risk Analysis
- It is necessary to ensure that the RSI parameter setting is reasonable, otherwise it may produce false signals in overbought and oversold situations.
- Tracking take profit needs to be updated in time, otherwise you may miss profits
- Pay attention to the risks caused by abnormal market fluctuations, and adjust positions or stop losses when necessary
## Optimization direction
- You can consider combining other indicators such as MACD to determine the trend
- Can test different RSI parameter settings
- You can introduce dynamic take-profit and automatically adjust the take-profit price according to market fluctuations
## Summarize
This strategy uses the RSI indicator to identify overbought conditions to determine the trend direction, and gradually take profits while tracking the upward trend. Compared with the traditional bearish RSI application method, this strategy provides new ideas. Through strict backtest verification, the strategy has achieved good performance. But we also need to pay attention to some potential risks and make parameter adjustments and optimizations. Overall, this strategy provides a simple and practical trend tracking solution for quantitative trading.
||
