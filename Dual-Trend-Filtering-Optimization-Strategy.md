...
1. An optimized trend tracking system based on the improved bimodal fluctuation tracker to determine the direction of the general trend.
2. The sub-trend filtering system based on the multi-period moving average combination further filters out some noise.
3. Alpha index provides final confirmation to ensure the reliability of trading signals.
Through the above triple protection, the strategy can make more accurate judgments on the general trend, and also have a strong filtering ability against short-term market noise.
## Principle
### Main trend tracking
Calculate the main trend direction using the improved Bimodal Fluctuation Tracking System TOTT and Close Series dual trend filtering. TOTT itself has strong filtering capabilities for noise. Close Series provides an additional level of confirmation. The combination of the two can make very accurate judgments on general trends.
### Subtrend filter
In addition to the main trend judgment system, the strategy also sets up a multi-period sub-trend filtering system based on EMA line combinations. There are many confirmation levels of Golden Cross and Dead Cross based on the EMA moving average relationship, which further improves the reliability of the judgment of the main trend direction and filters out more noise.
### Alpha Confirmation
When entering and closing positions, the strategy also checks the Alpha index value to ensure the reliability of the final trading signal. Alpha can reflect market buying and selling power and is a good confirmation indicator.
## Advantages
-Multiple protection design, more accurate judgment of general trends
- Powerful noise filtering ability
- Trading signals are stable and reliable
- Large space for parameter optimization
## Risk
- Signal generation frequency may be low
- Using moving averages in the tracking system can be broken through when the market changes violently.
To reduce the above risks, parameters can be adjusted to optimize the sensitivity of the tracking system, or more reversal indicators can be combined as a final filter.
## Optimization direction
- Adjust the parameters of the bimodal fluctuation tracking system to find a better parameter combination
- Try parameter optimization of different types of moving averages
- Optimize the moving average period of EMA line combination
- Updated Alpha filtering mechanism
- Add stop loss mechanism
## Summary
The overall design of this strategy is robust, the measures are appropriate, and the multiple protections and powerful noise filtering have won it stable performance. Through continuous parameter optimization and mechanism improvement, there is room for further improvement in the performance of the strategy.
||
