...
T7-JNSAR Quantitative Trading StrategyT7-JNSAR-Quantitative-Trading-Strategy
> Author
...
## Advantage Analysis
- The JNSAR line can better depict trends and key support and resistance.
- Generate signals based only on objective indicators to avoid the influence of subjective emotions.
- Use trend tracking to make profits, and historical backtesting returns are better.
...
## Risk Analysis
- As a trend following strategy, there are more possibilities for stop loss in consolidating markets.
...
- Only applicable to NIFTY, not applicable to other varieties.
- It requires strong psychological quality to continue trading all signals.
