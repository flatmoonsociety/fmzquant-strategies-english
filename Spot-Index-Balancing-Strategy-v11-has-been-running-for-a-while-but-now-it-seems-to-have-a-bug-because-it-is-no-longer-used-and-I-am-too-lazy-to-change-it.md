...
Spot Index Balancing Strategy-v11 has been running for a while, but now it seems to have a bug because it is no longer used and I am too lazy to change it.
> Author
...
Exponential balance strategy python version
> Strategy Arguments
...
|----|----|----|
|symbols|BTC,ETH,BCH,LTC|Trading pairs|
|slip|0.03|Order slippage|
|percent|0.2,0.2,0.2,0.2|Value proportion of each trading pair|
|delta|0.01|What is the difference to be balanced|
|Interval|2|Sleep time s|
|LogInterval|600|Earnings update time s|
|init_fund|-1|Initial Fund|
