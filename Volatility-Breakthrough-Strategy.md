...
![IMG](assets/images/3b5e8a80a6a58afa2cd90af1b666ec3ade5af90563c5f58ef77b6fe19649de2d.png)
[trans]

## Overview
The shock breakout strategy is a strategy that uses price shock patterns to conduct buying and selling operations when the price breaks through key support or resistance levels. This strategy combines multiple technical indicators to identify key trading opportunities.
## Strategy Principle
This strategy is mainly based on four technical indicators: the middle line of Bollinger Bands, the 48-day simple moving average (SMA), MACD and ADX. The specific logic is:
1. When the closing price crosses above or below the 48-day SMA, consider trading opportunities;
2. When the closing price breaks through the middle line of the Bollinger Bands, it is used as an entry signal;
3. MACD should be greater than or less than 0, as an auxiliary indicator to determine the trend direction;
4. ADX should be greater than 25 to filter out non-trending markets.
When the above four conditions are met, go long or short.
## Strategic Advantages
This is a strategy that combines trend and oscillators. Its main advantages are:
1. The 48-day SMA filters out excessively frequent transactions and locks in the mid- to long-term trend;
2. Break through the middle line of Bollinger Bands to grasp key support and resistance breakthrough points, and have a strong stop loss function;
3. MACD determines the direction of the general trend and avoids counter-trend trading;
4. ADX filters non-trending markets and improves the strategy winning rate.
In summary, this strategy has been optimized in many aspects such as controlling trading frequency, grasping key points, judging trends, and filtering invalid market conditions, and has a higher winning rate.
## Strategy Risk
This strategy mainly involves the following risks:
1. In a volatile market, the middle line of Bollinger Bands frequently triggers trading opportunities, which may lead to over-trading;
2. The ADX indicator also has certain errors when judging trends and invalid market conditions;
3. The risk of drawdown is relatively high, so it is suitable for investors with a certain risk tolerance.
## Strategy optimization
This strategy can be further optimized from the following aspects:
1. Increase the ATR indicator, set the stop loss level, and reduce the single stop loss;
2. Optimize Bollinger Band parameters and reduce the centerline trigger frequency;
3. Increase trading volume or trend strength indicators to judge the strength of the trend and avoid weak reversals.
## Summarize
To sum up, this shock breakthrough strategy is relatively mature as a whole and can effectively grasp the key trading points in the shock market. It combines trends and oscillators to grasp the balance between risk and return. Through further optimization, it is expected to obtain more stable excess returns.
||
