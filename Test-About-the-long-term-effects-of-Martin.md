...
Test-About the long-term effects of Martin
> Author
...
I don’t know if this counts as Martin. I want to do more. Just find any price to open a position. Then cover the position.
For example, the initial small cover is to prepare for a 10% drop.
For large cover positions, you can slowly set 10% 20% 50% if you can feel that the possibility of a fall is high to some extent. Just enlarge the position to cover the position to form a bargain hunting.
Therefore, pre-covering positions is very important. . .
Let’s use your talents. I hope you can have some suggestions and let’s do a good job in mechanical trading together.
The most important thing is to calculate the tolerance point. Don't explode. Currently this should be opened up to 8 times
> Strategy Arguments
...
|amountScale|3|Amount Accuracy|
|priceScale|5|Price Accuracy|
|bet|100|Order deposit|
