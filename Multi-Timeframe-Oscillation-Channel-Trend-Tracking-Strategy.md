...
![IMG](assets/images/1e055e9d151d3971ec4cb476abc922d854c37848ee7f4c92269062b37840299a.png)

[trans]

## Overview
This strategy is based on the super trend indicator, combines multiple time frames to analyze market trends, and uses the shock channel method to identify entry opportunities.
## Strategy Principle
- Use traditional super trend indicators to determine trend direction
- Added high time frame supertrend to ensure there is a trend on high time frames as well
- Determine the overall trend direction based on the Super Trend indicator on both time frames
- Determine the specific entry time based on the price breaking through the upper and lower rails of the shock channel
## Advantage Analysis
-Multiple time frame analysis, more reliable trend judgment
- The combination of high and low time frames not only ensures the general trend but also captures short-term opportunities.
- Set stop loss points on the shock channel to help control risks
## Risks and Solutions
- The super trend itself will have a certain lag, and the trend conversion point may be missed.
- Trend conversion can be known through parameter optimization or combined with other indicators to reduce the risk of lag
## Optimization direction
- Optimize super trend parameters and reduce lag issues
- Add trend filter indicators to ensure more accurate judgment of major trends
- Test and choose a more appropriate stop loss method
## Summary
This strategy integrates multi-time frame analysis and trend tracking indicators to grasp the main trends and find specific entry opportunities. Through continuous optimization, it is expected to achieve long-term and stable excess returns.
||
