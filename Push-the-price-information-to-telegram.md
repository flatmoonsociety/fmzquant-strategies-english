...
Set Bitcoin price and push instruction on WeChat-Push-the-price-information-to-telegram
> Author
...
Teaching strategies:
When the currency price is higher or lower than the set value, a message will be automatically pushed to WeChat. Minimum push interval can be set.
