...
Turtle Soup Strategy Counter Trend Trading Strategy
> Author
...
Turtle Soup, referred to as "Turtle Soup", is a trading strategy that is contrary to the Turtle trading rules. It takes advantage of many of the flaws of trend trading (especially the Turtle method) in false breakthroughs (making turtles into soup and eating them).
In the early 1980s, there was a very famous group of traders called the "Turtles." Richard Dennis, the market guru who created the trading legend, came up with this interesting name when he was training a group of new traders. Because Richard believes that training traders is actually like Singaporeans raising turtles. This trading method is called the Turtle Method, and this simple trend following technique has made their mentor Richard achieve great success.
More than twenty years later, the Turtle Method is no longer a secret and many people know about it. Despite this, why aren’t many people trading successfully with it? That's because trend following strategies often need to endure large and prolonged retracements. Many investors or traders do not have the capital or the willingness to hold on to these long-term losses. Usually most people get out before the trade turns in their favor.
Linda Warski and Larry Connoy named this "Turtle Soup" trading rule as opposed to the "Turtle Soup" trading rule in their book "Wall Street Wizards-Tried and Tried Short-term Trading Strategies" (Street Smarts). The reason most strategies fail to remain profitable is that their profitability degrades once many market participants use them. This is the method the market uses to balance those imbalances. Huasky found more successful and profitable results by trading the opposite of the Turtle method. Because the Turtle Method requires a lot of losing trades and waiting for bad trades to become profitable. Usually when it makes a profit, it offsets all those losses before making a profit, and this happens over and over again. Obviously, the name of the strategy "Turtle Soup" created by Waskey is a kind of American humor. It uses the costs of turtle traders to make profits (making turtles into soup and eating them).
The original "Turtle" trading rules are at least swing trading or longer, with time spans between a week and a month. Ms. Huaski uses the "turtle soup" strategy to do shorter-term intraday or swing trading, taking advantage of the high-frequency occurrence of false breakthroughs. Generally speaking, the "turtle" method uses a 20-day cycle breakout: buy if it breaks the 20-day high, and sell if it falls below the 20-day low. The "Turtle Soup" trading rule takes the exact opposite approach.
Strategy features:
Support any level of trend tracking (minute K, hour K, daily K, weekly K, etc.)
Support any trading pair (ETH/BTC, BSV/BTC, etc.)
Support any exchange
Detailed strategy reports (including strategy status, transaction history, etc.)
Supports nearly 10 custom personalized parameters
Dependency botvs_tools template library download:
