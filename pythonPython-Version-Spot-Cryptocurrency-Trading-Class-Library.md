...
Python version of spot digital currency trading class library Python-Version-Spot-Cryptocurrency-Trading-Class-Library
> Author

Inventor Quantification-Little Dream
> Strategy Description

Spot digital currency trading library (python version)
> Strategy Arguments
...
|----|----|----|
|OpMode|0|Order method: take order|pending order|
|MaxSpace|0.5|Pending order failure distance|
|SlidePrice|0.1|Sliding price for placing an order|
|MaxAmount|0.8|Maximum order amount for opening a position|
|RetryDelay|500|Failure retry milliseconds|
|MAType|0|Moving average type: TA.EMA|TA.MA|
|_GetMinStocks|0.01|Minimum trading volume|
