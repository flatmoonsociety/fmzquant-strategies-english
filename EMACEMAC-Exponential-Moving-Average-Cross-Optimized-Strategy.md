...
EMAC Exponential Moving Average Cross Optimization Strategy EMAC-Exponential-Moving-Average-Cross-Optimized-Strategy
> Author
...
![IMG](assets/images/87517fb5d8f691871f04102ea76ab94f6826cfbc4c82319a76a2718fa820c6eb.png)
[trans]

## Overview
The EMAC exponential moving average crossover optimization strategy is a parameter-optimized version of the basic EMAC strategy. This strategy integrates trend judgment, multiple moving average filtering and stop-loss and take-profit exit, aiming to seize the mid- to long-term trend and follow the trend.
## Strategy Principle
1. Determine the direction of the recent trend: Calculate the rise and fall of the closing price in the past 26 periods, and judge it as rising, falling, or oscillating.
2. Multiple moving average filtering: Calculate the 10-period, 20-period, and 34-period EMAs, and generate a buy signal when they cross the 50-period SMA.
3. ATR stop loss: When the Entry signal appears, the stop loss level is set to the low or high point of the Entry bar minus 2.5 ATR.
4. Trailing Stop: Gradually move the stop loss line upward as the price rises.
5. Target take profit: When the Entry signal appears, set the target level to the closing price plus 3ATR.
6. MA moving average pullback stop-loss Exit: When the price falls back below the 10-day EMA, actively stop the loss and exit.
## Strategic Advantages
1. Multiple moving average filtering increases the reliability of signals and avoids being misled by false breakthroughs.
2. Using ATR stop loss, you can set a reasonable stop loss distance based on market volatility.
3. The trailing stop moves the stop loss line gradually upward, protecting part of the profit.
4. Target take profit: Set a reasonable profit target, don't be greedy, and avoid spitting out profits.
5. MA callback Exit allows timely stop loss and exit when the trend reverses.
## Strategic risks and solutions
1. In a volatile market, the EMA moving average is prone to cross-crossing multiple times, which may lead to the risk of continuous losses. You can appropriately increase the EMA parameters or add MA golden cross filter conditions to reduce this probability.
2. When the ATR value is large, the stop loss distance is too large and the risk of loss increases. You can consider using the moving average of ATR or multiplying ATR by a scaling factor for optimization.
3. Failure to consider nighttime space risks. The judgment logic of the night trading suspension time period can be added to avoid signals appearing during times when trading is not possible.
4. Failure to consider the impact of the market situation. The judgment of the market trend can be added as one of the switching conditions of the strategy to reduce losses in adverse market conditions.
## Strategy optimization direction
1. You can test EMA parameter combinations of different lengths to find the moving average length that is more suitable for different varieties.
2. You can test the moving average or coefficient reduction method of ATR to optimize the stop loss distance.
3. Judgment logic for night trading suspension time period can be added to avoid overnight risks.
4. You can add judgment on the market trend and set switching conditions when the market trend is unfavorable.
5. Parameter combinations can be selected by back-testing years of historical data so that the strategy has the best stability in backtesting.
## Summarize
The EMAC exponential moving average crossover optimization strategy combines trend judgment, multiple moving average filtering and dynamic stop loss and profit taking, aiming to track the medium and long-term trends for long-term holdings. Compared with the original version, the parameters have been optimized and it is expected to achieve better real-time performance. However, this strategy still needs to be further optimized and improved, adding more logical judgments to cope with various market conditions, reducing risks in real trading, and improving the stability and profitability of the strategy.
||
