...
![IMG](assets/images/b3c3f59ba1af53476ef400921826bdb5f8a9c1b3c892210e69bfd76e27045390.png)
[trans]

## Overview
This strategy is a quantitative trading strategy based on Bollinger Bands and MACD indicators. It combines two mainstream technical indicators to identify trading opportunities, aiming to obtain a higher winning rate in trending markets.
The strategy will establish a long position to seek Trend Following when the price breaks through the lower track of the Bollinger Band, and close the position when the price breaks through the upper track; at the same time, the MACD indicator will be used to determine the momentum direction to filter out false breakthroughs. The configurable RSI indicator helps determine overbought and oversold to further avoid losses.
## Strategy Principle
This strategy mainly consists of the Bollinger Bands indicator and the MACD indicator.
The Bollinger band is based on the standard deviation of the stock price to calculate the upper and lower bands. When the stock price breaks above the upper band upward, it is an overbought signal, and when the stock price falls below the lower band, it is an oversold signal. This strategy goes long when the price breaks through the lower rail, and closes the position and stops the loss when it falls below the upper rail.
The MACD indicator determines the momentum and direction of the stock price. When the short-term average breaks through the long-term average, it is a buy signal, and vice versa is a sell signal. This strategy combines the MACD indicator to filter out false breakouts from the Bollinger Bands.
In addition, the RSI indicator can help determine whether it is overbought or oversold. When the RSI is low, it indicates oversold, which can strengthen the buy signal. When the RSI is high, it indicates overbought, which can strengthen the sell signal.
## Strategic Advantages
This strategy combines three indicators: Bollinger Bands, MACD and RSI, which can effectively determine price trends and fluctuations. Has the following advantages:
1. Bollinger band determines the price fluctuation range and can capture the Trend Following
2. MACD determines the direction of momentum and filters out Bollinger’s false positives
3. RSI assists in judging overbought and oversold to avoid opening positions to chase high prices.
4. A higher winning rate can be obtained through parameter optimization
## Strategy Risk
This strategy also has some risks that you need to be wary of:
1. When the stock price fluctuates violently, the risk of stop loss is greater
2. When parameters are set improperly, profitability will decrease.
3. When the trend reverses, the MACD indicator will misjudge
Countermeasures:
1. The stop loss range can be appropriately relaxed
2. Multiple backtests are needed to find the best parameter combination.
3. More indicators can be used to predict price turns
## Strategy optimization direction
This strategy has the following main optimization directions:
1. Optimize the parameters of Bollinger belt to adapt to more market environments
2. Add more indicator judgments to improve strategy stability
3. Use machine learning algorithms to automatically optimize parameters
4. Test the strategy effect on high-frequency data
5. Add a fund management module to control single losses
## Summarize
This strategy is generally a typical trend following strategy. It combines a variety of technical indicators to enhance stability and achieve a good winning rate when the judgment is accurate. But there are certain risks that need to be noted. Through continuous optimization and adjustment, strategy performance can be further improved.
||
