...
Dynamic Trend Tracking Optimization Strategy-Dynamic-Trend-Tracking-Optimized-Strategy
> Author
...
![IMG](assets/images/669edef74d7d8f0463d0e35e2565f01768dc08207d50f82d8959727be8227a6b.png)
[trans]

### Overview
This strategy dynamically draws support lines by calculating the CMO indicator and change rate. A trading signal is generated when the price breaks through the support line. At the same time, the strategy also locks in more profits by optimizing the stop loss range near the support line.
### Strategy Principles
1. Calculate CMO indicators to determine price trends
2. Calculate the rate of change Var to reflect the price change trend
3. Draw support lines based on the rate of change
4. Calculate the optimized stop loss lines longStop and shortStop
5. Generate a trading signal when the price breaks through the support line
### Advantage Analysis
1. Use CMO indicators to determine price trends and avoid false breakthroughs
2. Support lines can clearly determine the trend direction
3. Optimized stop loss lines can lock in more profits
4. The trading signals are simple and clear, and easy to follow.
### Risk Analysis
1. The CMO indicator lags and may miss the price turning point
2. A breakthrough of the support line may form a false signal
3. Improper optimization of stop loss range may lead to greater losses
Risk resolution:
1. Appropriately adjust CMO parameters to reduce lag
2. Combine with other indicators to filter false signals
3. Test to determine the appropriate stop loss optimization ratio
### Optimization direction
1. Combine more indicators to filter out false signals
2. AI automatically optimizes the stop loss range
3. Automatically adjust trading volume
### Summarize
This strategy works well overall, using support lines to clearly determine the direction of the trend. At the same time, combining CMO indicators and optimized stop loss can achieve good results. However, there is a certain risk of false signals, which can be optimized through a combination of multiple indicators.
||
