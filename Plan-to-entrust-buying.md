...
Plan to entrust a purchase, and carry out the purchase operation after the price rises above or falls below the specified price. If you use a market price order, you only need to write the purchase amount. If you use a limit price order, you need to specify the price and number of the limit order.
> Strategy Arguments
...
|BuyPrice|2610|Limit Order - Buy Price|
|BuyAmount|3|Limit Order - Buy Amount|
