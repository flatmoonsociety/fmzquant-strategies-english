...
|sale_buy_diff|0.03|Buy-ask spread, selling price - buying price|
|two_distance|0.01|The distance of each grid when increasing or decreasing|
|trade_amount|2|Amount per trade|
|sale_price_max|5|Maximum selling price|
|buy_price_min|true|The upper limit price of buying|
