...
|----|----|----|
|filePathForCSV|CSV file path|CSV file path|
|startTime|Start time for generating K-line data, format: 2023-11-01 00:00:00|Start time (UTC time)|
|endTime|The end time of the generated K-line data, format: 2023-11-02 00:00:00|End time (UTC time)|
|KLinePeriod|The K-line period of the K-line data to be generated, 1h, 1d, 1m, etc. |K line cycle|
|firstPrice|Starting price of K-line data|Starting price of K-line data|
|ratio|Volatility coefficient|Volatility coefficient|
|trendType|Voltage Type|Voltage Type|
|pround|Price accuracy, price accuracy of K-line data|Price accuracy|
|vround|Order volume accuracy|Order volume accuracy|
...
|----|----|----|
|createRecords|Generate random K-line data|Generate random K-line data|
