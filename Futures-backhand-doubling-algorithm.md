...
796 futures backhand doubling algorithm, open short or long first, you can also specify to continue in the last direction if it fails. If it fails, increase the position by the specified multiple. The strategy is risky and is for learning only.
> Strategy Arguments
...
|OpType|0|Opening direction: long|short|
...
|StopProfit|0.2|Stop Profit (Percent)|
|StopLoss|0.1|Stop Loss (Percent)|
|ReverseRate|2|Reverse hand increase multiple|
|MaxLoss|10|Maximum number of backhands|
|ReverseMode|0|Backhand mode: reverse position|short position|
|MinStock|0.01|Minimum trading volume|
