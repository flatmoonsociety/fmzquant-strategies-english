...
![IMG](assets/images/ffdc30d9bc297d258f349a33049df61a485085b126d0f17dbc330c85e15740d2.png)
[trans]

## Overview
This strategy calculates moving averages of different periods and sends trading signals when the shorter period moving average crosses the longer period moving average, which is a typical moving average crossover strategy. The strategy supports both long and short selling, enabling two-way trading.
## Strategy Principle
This strategy is based on the intersection between moving averages of different periods to determine market trends and issue trading signals. The strategy uses three moving averages of 8 periods, 13 periods and 21 periods, of which the 8 period line is the shorter period line and the 21 period line is the longer period line. When the 8-period line crosses the 21-period line, a long signal is generated; when the 8-period line crosses below the 21-period line, a short signal is generated.
When executing specific transactions, this strategy also adds a judgment condition to avoid being trapped in transactions under tortuous market conditions. That is, an order will only be placed when the closing price of the K-line is higher than (long signal) or lower than (short signal) the crossover point. This can effectively filter out some false signals.
## Strategic Advantages
1. Apply the moving average crossover principle to effectively track market trends
2. Set up transaction filtering conditions, which can filter out some false signals and avoid getting stuck.
3. Support two-way trading, and you can gain profits in both the up and down stages of the market.
4. Use cross-period moving average crossovers to capture transitions between larger levels
5. The strategy logic is simple and clear, easy to understand, modify and optimize
## Strategy Risk
1. Failures may occur and a large number of false signals may occur under sharp market fluctuations.
2. If you are unable to make a judgment when the market is flat, you will miss some opportunities.
3. Inter-cyclical cross judgments lag behind, and short-term trend turning points may not be captured in time.
4. The impact of stock price volatility is not considered, and parameters need to be adjusted under different volatility
5. If there is no stop loss and stop profit, there is a risk of unlimited losses.
### Risk Solutions
1. Combine with other indicators to judge the market and avoid the impact of volatile market conditions
2. Reduce the moving average period and improve judgment sensitivity
3. Add a stop-loss and stop-profit mechanism to strictly control trading risks and profit drawdowns
## Optimization direction
1. Combine with other technical indicators such as MACD, KDJ, etc. to make judgments and improve the effect.
2. Test the impact of different parameter settings on the overall effect of the strategy
3. Set adaptive parameters based on market type and volatility
4. Optimize the moving average calculation method, using DEMA, ZLEMA and other indicators
5. Add stop loss and take profit logic
6. Optimize quantitative backtest indicators and determine optimal parameters
## Summarize
The overall idea of ​​this strategy is clear, and it uses simple and effective moving average crossovers to determine the relationship between long and short period trends and capture rotation opportunities. Strategies can be traded in both directions and are easy to understand and optimize. However, there are also some risks that need to be further improved, such as the inability to effectively handle specific market conditions, and the lack of stop loss and profit control to control transaction risks. Through subsequent combination of technical indicators and parameter optimization, strategy stability and profitability can be further enhanced.
||
