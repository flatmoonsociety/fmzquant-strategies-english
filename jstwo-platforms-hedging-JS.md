...
Dual platform hedging js version two-platforms-hedging-JS
> Author
...
|----|----|----|
|MinSpreadA|0.51|A->B spread|
|MinSpreadB|0.52|B->A spread|
|MaxAmount|0.3|Maximum operation amount|
|BalanceTime|10|Balance period (seconds)|
|LoopInterval|200|Polling period (ms)|



|Button|Default|Description|
|----|----|----|
|A->B|0.51|Change spread (A->B)|
|B->A|0.52|Change spread (B->A)|
