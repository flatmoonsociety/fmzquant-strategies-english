...
|FMZ_AccessKey|xxx|AccessKey of FMZ platform|
|FMZ_SecretKey|xxx|SecretKey of FMZ platform|
|maxBuffSignalRowDisplay|20|Maximum number of signal display rows|
