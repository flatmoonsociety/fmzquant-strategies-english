...
Moving Average-Trend_Digital Currency Strategy V02
> Author
...
@太极QQ7650371
#EMA/TREND STRATEGY
#By judging how much the rebound will be after the dead cross bottoms, buy
...
|----|----|----|
|FastPeriod|2|Open position fast period|
|SlowPeriod|4|Slow period for position opening|
|EnterPeriod|true|Opening observation period|
|x|------------------------------------------------------------------------------|Separation symbol|
|ExitFastPeriod|2|Close position fast period|
|ExitSlowPeriod|4|Close slow line period|
|ExitPeriod|2|Close observation period|
|xx|------------------------------------------------------------------------------|Separation symbol|
|PositionRatio|0.5|Position Ratio|
|Interval|10|Polling period (seconds)|
|xxx|---------------------------------------------------------------------------------|Separation symbol|
