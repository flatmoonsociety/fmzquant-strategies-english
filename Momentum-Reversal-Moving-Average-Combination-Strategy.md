...
![IMG](assets/images/55196fc506ece03db07da9801f57c9a6b483bc670ddff01620b1ecc6dd600a4c.png)
[trans]

## Overview
This strategy uses a combination of multiple moving average indicators to identify trends. Specifically, this strategy uses both a fast moving average group and a slow moving average group. The fast moving average group is composed of the 5-day EMA and the 25-day WMA, and the slow moving average group is composed of the 28-day EMA and the 72-day WMA. A buy signal is generated when the fast moving average crosses the slow moving average, and a sell signal is generated when the fast moving average crosses below the slow moving average. In addition, this strategy will also combine the RSI indicator to assist in judgment.
## Strategy Principle
1. Use double moving averages to determine trend direction
    - Fast moving average combination: 5-day EMA, 25-day WMA
    - Slow moving average combination: 28-day EMA, 72-day WMA
    - When the fast moving average crosses the slow moving average, a buy signal is generated
    - When the fast moving average crosses the slow moving average, a sell signal is generated
2. Use the RSI indicator to help determine the timing of buying and selling.
    - RSI low buy: A buy signal is generated when RSI <35
    - Sell when RSI is high: A sell signal is generated when RSI>65
3. Adopt trend following mechanisms, including trailing stop loss and trailing take profit
    - Trailing stop loss: Track the highest price/lowest price to prevent losses from expanding
    - Mobile take profit: track the highest price/lowest price and take profit in time
## Advantage Analysis
1. Use double moving averages to determine trends. The combination of fast and slow moving averages can effectively identify trend turning points.
2. The auxiliary judgment of the RSI indicator can avoid false signals generated by the moving average.
3. The trailing stop loss mechanism can effectively control the losses of individual losing transactions.
4. The moving take-profit mechanism can lock in profits and avoid profit taking.
## Risk Analysis
1. The probability of failure to judge the double moving average is high, and false signals may appear.
2. Improper setting of RSI parameters may miss trading opportunities
3. Setting the stop loss range too large may cause unnecessary losses
4. If the take-profit range is set too small, profits may shrink.
## Optimization direction
1. The parameters of fast moving average and slow moving average can be optimized to find the best parameter combination.
2. The parameters of RSI can also be optimized to find better overbought and oversold lines.
3. Experiment with different stop loss widths to find the balance between minimizing losses and avoiding false signals
4. Try an adaptive take-profit strategy so that the take-profit range can be adjusted according to market fluctuations
## Summary
This strategy uses dual moving averages to determine the trend direction, the RSI indicator to assist in determining timing, and the moving stop-profit and stop-loss methods to capture and track the trend. By optimizing the parameters of the moving average and RSI, as well as the take-profit and stop-loss settings, better results can be obtained. The overall idea of ​​this strategy is clear, easy to understand and optimize, and it is a highly practical trend following strategy.
||
