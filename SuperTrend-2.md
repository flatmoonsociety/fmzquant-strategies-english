...
|----|----|----|
|Amount|true|Amount of a position opened|
|TradeInterval|2000|Trading interface access polling interval|
|PriceTick|0.5|One-tap price of variety|
|Symbol|quarter|Contract code|
|pd|45|SuperTrend parameter pd|
|factor|3|SuperTrend parameter factor|
