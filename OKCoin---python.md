...
Transplantation-OKCoin-leek harvester-multi-variety version-annotated python version
> Author

Go to Boren
> Strategy Description

At the request of a forum friend, it has been changed to a multi-variety version (the parameters are still unified parameters, if you need different parameters for each currency, please change it yourself)
> Strategy Arguments
