...
Specific reference article: https://www.fmz.com/digest-topic/5834
> Strategy Arguments
...
|----|----|----|
|MaxAmount|1000|Maximum order amount|
|ProfitTime|60|Print profit time interval|
|Fee|0.05|Taker fee%|
|PeriodTradeBack|0.0001|Amount of BTC unlocked per trade per minute|
|CoverCost|0.25|Default transaction closing loss|
