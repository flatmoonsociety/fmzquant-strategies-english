...
![IMG](assets/images/94b61e5406bc38464d7ac1015a8d9f74c62375f176e7a130712c8dc5b8909dcd.png)

[trans]


## Overview
This strategy uses the comparison between the inside and outside of the Bol Band channel to determine the trend, and combines the momentum indicator to track the trend, which is a trend following strategy. The strategy determines that when the fluctuation within the channel is smaller than outside the channel, a new trend direction signal is generated and a position is opened. The position stop loss uses the ATR multiplier, and the take profit is the ATR multiplier risk-reward ratio.
## Principle
This strategy mainly consists of the following parts:
1. Bohr band settings: including a large Bohr band length of 40 periods, a small Bohr band length of 20 periods, and a channel width of 2 times the standard deviation.
2. Channel explosioin judgment: If the upper track of the large Bol Band is lower than the upper track of the small Bol Band, and the lower track of the large Bol Band is higher than the lower track of the small Boll Band, it means that the fluctuations have increased and a new trend direction signal has been generated.
3. Momentum indicator: 14-day EMA with 240 periods to determine the trend direction.
4. ATR stop loss and take profit: ATR is 14 times the stop loss distance, and take profit is 1.5 times the stop loss distance.
The strategy first determines whether the channel breaks out. If the channel breaks out, it then judges the direction of momentum and decides whether to go long or short. After entering the market, stop-loss and stop-profit management is performed based on ATR multiples.
## Advantages
1. Using the double Bohr band structure, you can compare fluctuations in different time periods and determine the trend breaking point.
2. Use momentum indicators to determine the trend direction and avoid being whipsawed by the volatile market.
3. Use ATR for stop loss and profit management, and the stop loss distance can be adjusted according to market fluctuations.
4. The risk-reward ratio is reasonable, avoid excessive pursuit, and not be too conservative.
## Risk
1. In a volatile market with no clear trend, it is easy to get caught. Misjudgments can be reduced by optimizing the momentum indicator parameters.
2. ATR stop loss may be too conservative, you can test other stop loss methods, such as trailing stop loss, etc.
3. Fixed stop-loss and take-profit multiples may not be suitable for all varieties, and you can consider making them adjustable.
4. The effect of double Boer bands in judging trend turning points is doubtful. You can test other channel indicators such as KD channel, etc.
## Optimization direction
1. Test different momentum indicator parameters and find the best parameter combination.
2. Try different stop loss methods, such as trailing stop, adaptive ATR, etc.
3. Make the stop-loss and take-profit multiples adjustable and optimize them according to different varieties and market environments.
4. Test the effects of different channel indicators and select more stable channel indicators.
5. Consider adding compound interest management to make profits more controllable.
6. You can filter entry opportunities based on band, time, etc. to increase your winning rate.
## Summarize
The overall idea of ​​this strategy is clear, and the use of double Boer bands to determine the trend breaking point is its biggest highlight. However, it is still necessary to optimize and test stop loss methods, channel indicators, risk management and other aspects to make the strategy parameters more adaptable and operate stably in different market environments. Overall, this strategy has good advantages and development potential and is worthy of in-depth study.
||
