...
Multiple chart example data can be downloaded as csv and other tables Multiple-charts-example
> Author

grass
> Strategy Description

An example of displaying multiple charts. Multiple charts can share one line and the width of the chart display can be set.
Supports basic charts of HighCharts and HighStocks, such as line charts, histograms, column charts, pie charts, K-line charts, etc. For details, check the highchart official website and follow this example with slight changes.
