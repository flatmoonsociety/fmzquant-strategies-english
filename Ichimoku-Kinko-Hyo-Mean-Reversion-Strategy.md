...
Ichimoku-Kinko-Hyo-Mean-Reversion-Strategy
> Author
...
## Overview
This strategy comprehensively uses a variety of technical indicators such as the Ichimoku Kinko Hyo indicator, daily breakthroughs, Gaussian smoothed moving averages, MACD indicators, etc. to judge the trend direction and find more reliable entry points.
## Strategy Principle
1. Ichimoku Kinko Hyo indicator judgment: Conversion Line crossing Base Line is considered a bullish signal.
2. Judgment of daily breakthrough: Today's closing price rises by a certain percentage from yesterday's closing price to confirm a bullish signal.
3. Gaussian smooth moving average judgment: when the price crosses the moving average, it is considered a bullish signal.
4. MACD judgment: when the DIFF line crosses the DEA line, it is considered a bullish signal.
5. Based on the above multiple factors, it is judged that the market is facing a trend change and the time point for bullish entry is determined.
## Strategic Advantages
1. Comprehensive judgment of multiple indicators to improve the accuracy of judgment.
2. Confirm intraday and multi-time frame judgments together to avoid false breakthroughs.
3. Ichimoku Kinko Hyo’s judgment of trends is accurate and reliable.
4. Gaussian smoothed moving average has the characteristic of small hysteresis.
5. MACD can determine when momentum is about to turn.
## Strategy Risk
1. There are relatively few opportunities for multiple conditions to be established at the same time, which may lead to missing the better entry point.
2. Improper setting of indicator parameters may cause wrong signals to be issued.
3. There may be differences between intraday judgment and multi-time frame judgment.
4. False breakthroughs may still occur, causing losses.
Corresponding optimization method:
1. Adjust indicator parameters to expand entry opportunities.
2. Test different varieties and cycle parameter combinations and optimize parameters.
3. Optimize the time frame configuration to coordinate the signals of each time frame.
4. Set stop loss and stop profit to control single loss.
## Strategy optimization direction
1. Test combinations of different indicators to find better combinations.
2. Add machine learning algorithms and use more data to improve judgment capabilities.
3. Increase trend detection and avoid counter-trend trading.
4. Optimize the fund management strategy and make the strategy more stable.
5. Optimize stop-loss and take-profit strategies to maximize profits.
## Summarize
This strategy integrates multiple indicators to determine the trend direction, and enters the market when a bullish opportunity is determined with a higher probability. It is jointly verified by multiple time frames and multiple indicators to improve the accuracy of judgment. It can be optimized by adjusting parameter windows, optimizing combinations, and introducing more data, integrating more factor signals, and obtaining more trading opportunities while maintaining stability.
|| 
