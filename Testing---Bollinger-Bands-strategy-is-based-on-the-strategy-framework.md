...
Testing - Bollinger Bands strategy is based on the strategy framework
> Author
...
|----|----|----|
|isLogReset|true|Whether to clear the log at startup|



|Button|Default|Description|
|----|----|----|
|upDateAmount|true|Update open position button|
|cmdOpen|__button__|Open position command|
|cmdCover|__button__|Close position command|
