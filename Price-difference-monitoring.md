...
Only supports two exchanges, the type of spread can be customized, and the custom chart function of the 2.77 custodian is supported.
> Strategy Arguments
...
|----|----|----|
|AType|0|Main platform price type: Last transaction price|Buy price|Sell price|
...
|USDCNY|false|USDCNY|
|NormalDiff|0.1|Normal spread|
|HighDiff|0.3|Higher Difference|
