...
Contract Hedging_Order Multi-threaded Version
> Author
...
|VariesCount|true|Number of trading varieties|
|LoopInterval|2|Delay|
|VariesString|BTC|ETH|Trading Varieties|
...
|CloseNarrowSpreadString|5|6|9.7|9.8|10.2#2.1|2.2|2.3|2.4|2|2|2|Narrow the price difference in the same direction and close the position|
|NormalDiff|0.1|Normal spread (picture)|
|HighDiff|0.3|Higher Difference (Picture)|
|PriceCancelRatioString|0.02|0.02|Cancellation value (percentage)|
|SlideString|0.8|0.1|Sliding value|
...
|IsShowLog|false|Whether to display the log|
