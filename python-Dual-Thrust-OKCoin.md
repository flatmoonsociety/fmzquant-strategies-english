...
Dual Thrust strategy includes complete chart display, dynamic chart update, template reference and other functions, and can be used as a learning template.
> Strategy Arguments
