...
Requires OKX futures account, one-way position mode
> Strategy Arguments
...
|----|----|----|
|Pair_A||Transaction currency A|
|Pair_B||Transaction currency B|
|Quote||Base Currency|
|Pct||Grid size|
|Trade_Value||Trade value|
|Ice_Value||Iceberg commission value|
|Max_Value||Maximum position|
|N||Average price parameters|
