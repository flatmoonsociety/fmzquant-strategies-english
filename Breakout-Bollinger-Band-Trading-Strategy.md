...
## Overview
This strategy is based on the Bollinger Bands breakthrough principle. When the price completely breaks through the upper or lower rails, reverse operations are performed. It can capture the return to the moving average after abnormal fluctuations and is suitable for active traders who pursue efficient profits.
## Principle
This strategy uses Bollinger Bands to define the current range of market volatility. When the price forms a complete positive column or negative column and completely breaks through the upper or lower Bollinger Band, it means that the market has reached a state of high volatility and the price will reverse and return to the moving average.
Specifically, the strategy uses the closing prices of 20 K lines to calculate the middle track, upper track and lower track of the Bollinger Bands. When the price is below the lower track and the closing price is lower than the opening price, a long signal is generated. When the price is above the upper track and the closing price is higher than the opening price, a short signal is generated. Then use the breakthrough point as the stop loss level and the middle rail as the first target price to close the position.
## Advantages
The main advantages of this strategy are as follows:
1. Use Bollinger Bands to judge the degree of market fluctuations and effectively identify abnormal conditions.
2. The breakthrough point serves as a stop loss level, which can effectively control risks.
3. Return to the middle track and set a reasonable target level to avoid excessive pursuit of gains and losses.
4. Complete K-line filtering of false breakthroughs to improve signal quality.
5. Simple parameter setting, easy to implement and optimize.
6. The logic is clear and easy to understand, and the code is concise and elegant.
## Risk
This strategy also has the following risks:
1. Improper Bollinger Band parameters may lead to failure.
2. A breakthrough may be the beginning of a new trend, and there is a risk of early exit.
3. The mid-track target may be too conservative to make sustained profits.
4. Large breakthroughs cannot be fully filled, and there is a risk of slippage.
5. Fluctuating trends may result in frequent unnecessary transactions.
## Optimization direction
This strategy can be optimized by considering the following points:
1. Assess the strength of the trend and adjust parameters or trading frequency.
2. Combine with other indicators to determine the best entry point.
3. Adjust the stop loss width according to the degree of volatility.
4. Optimize the first target setting to achieve smooth profits.
5. Add a re-entry mechanism to optimize profits.
6. Evaluate the credibility of breakthroughs to avoid mistaken trades.
## Summarize
This strategy is based on the Bollinger Bands breakthrough principle and is suitable for active traders who pursue short-term profits. The advantage is clear risk control, but the disadvantage is the possibility of early exit and limited profit margins. The effect can be improved through parameter optimization, auxiliary indicators and other methods.
|| 
