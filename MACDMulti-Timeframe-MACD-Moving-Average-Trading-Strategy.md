...
![IMG](assets/images/4906a44cb9d540ce9ece340b9da006c37efe9e21e191db5bce7027b2963984c9.png)
 [trans]

## Overview
This strategy determines trading signals based on the MACD indicator and moving averages of multiple time periods. It comprehensively utilizes the performance of the MACD indicator in different cycles and the price position relationship with respect to different moving averages to design the entry and exit rules for long and short positions.
## Strategy Principle
### 1. MACD indicator
- Calculate 5-minute, 15-minute, 1-hour and 4-hour moving averages
- Determine trends through the relationship between price and moving averages of different periods
### 2. RSI indicator
- Calculate RSI values for the current period and higher periods
- Use RSI high reversal and low reversal to determine reversal signals
### 3. K-line pattern
- Calculate various combinations of positive and negative lines to determine reversal signals
- Pay attention to important support and pressure levels based on price levels
### 4. Admission rules
**Conditions for going long:**
- The RSI indicator of the current cycle has crossed the low level
- The high-cycle RSI indicator shows a bottom divergence, indicating that a reversal is imminent.
**Short selling conditions:**
- The RSI indicator in the current cycle has crossed below the high level
- The high-cycle RSI indicator has a top divergence, indicating that a reversal is imminent
### 5. Appearance rules
**Pingduo Conditions:**
- A reversal signal appears on the K line: the trend reverses to a negative line, such as morning star and dark cloud cover, etc.
**Short closing conditions:**
- A reversal signal appears on the K line: the trend reverses to a positive line, such as light foot and huge swallowing, etc.
### 6. Risk control rules
Set stop loss and take profit standards to avoid losses from expanding and profits from shrinking.
## Advantage Analysis
1. Multi-indicator combination, comprehensive judgment, high signal accuracy
2. Make full use of information in different cycles to increase the probability of profit
3. Strict entry and exit rules and controllable risks
## Risk and Optimization
1. Improper parameter optimization may lead to too frequent transactions
2. Indicator parameters need to be optimized to adapt to different varieties
3. You can set dynamic stop-profit and stop-loss to lock in profits
## Summarize
This strategy is generally relatively stable. Through multi-indicator judgment and strict entry and exit rules, it can effectively grasp market trends and avoid transaction risks. However, further optimization is still needed to improve revenue stability.
|| 
