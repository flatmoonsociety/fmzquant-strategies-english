...
Chart template adds status bar table
> Author
...
|indicators_1|Indicators 1|Indicators 1|
|indicators_2|Indicators 2|Indicators 2|
|indicators_3|Indicators 3|Indicators 3|
|Interval|500|Interval (milliseconds)|
|isOpenRightY|true|Whether to open the right Y axis|
