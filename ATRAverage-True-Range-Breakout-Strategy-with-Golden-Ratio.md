...
## Strategy Principle
In the code, the ATR cycle indicator of the closing price is obtained, and amplified by 1.618 times as the upper track, and amplified by 2.618 times as the lower track, and combined with the moving average EMA to construct a Bollinger Band breakthrough trading system. Go long when the price breaks through from the lower track upwards, and go short when the price breaks through from the upper track downwards to achieve trend following profits.
## Strategic Advantages
1. The ATR indicator can effectively capture market volatility, use volatility to build adaptive trading channels, and avoid overfitting caused by using fixed parameters.
2. The ATR upper and lower rails enlarged by the golden section can expand the profit space without increasing the trading frequency.
3. The moving average system filters out short-term noise, and can lock in the mid- and long-term trends in conjunction with the ATR channel.
## Strategy Risk
1. The ATR indicator lags behind in responding to extreme market conditions.  
2. Improper golden section magnification may lead to excessive trading frequency.
3. The long-period moving average switching signal lags behind.
## Strategy optimization
1. The ATR indicator can be used in conjunction with the market volatility index VIX or the amplification factor can be adjusted.  
2. The moving average system can introduce multi-time period EMA to build an adaptive trading system.
3. A stop-loss mechanism can be set up to reduce the maximum loss in a single transaction.
## Summary
This strategy comprehensively uses moving average filtering, ATR channel tracking and the golden section principle. It can effectively track medium and long-term trends and has good stability. Parameter adjustment can adapt to the applications of different varieties and different cycles, and it is worth exploring its good market adaptability.
||
