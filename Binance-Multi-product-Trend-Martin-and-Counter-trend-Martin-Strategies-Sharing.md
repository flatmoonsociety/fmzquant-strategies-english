...
Binance Multi-product Trend Martin and Counter-trend Martin Strategies Sharing
> Author

high frequency quantization
> Strategy Description

Policy customization vx:18826683356
Strategy source: FMZ website
Because many people ask me to write Martin-type strategies.
Then I found a working one on the website to share with you.
I hope it will be helpful to everyone’s investment activities
The real-disk test can be run
Private address: https://www.fmz.com/robot/1fa0aeff0dfdd66645a198f28766aa0c
Strategy features:
1. Trend order opening
2. Cover up positions against the trend
3. With wear and tear release
4. Arbitrage automatically transfers to spot
...
|----|----|----|
|OpType|0|Operation type: long|short|Auto: long|short|long and short double|
|M|20|Leverage multiple|
|P|100|Order value|
|IsAuto|false|Enable trend|
|IsHt|true|Enable callback|
|Z|true|Retracement take-profit trigger threshold (%)|
|K4|8|Profit retracement take profit percentage (%)|
|E1|0.6|1-2 position covering interval|
|E2|true|3-4 margin interval|
|E3|1.5|5-6 margin interval|
|E4|2|6+margin interval|
|HcK4|8|Callback margin percentage (%)|
|C1|0.5|Guaranteed closing line|
|longAddRate|true|multiple of long positions|
|shortAddRate|true|Short position increase multiple|
|Jt|true|Whether to automatically unwind|
|maxLAC|10|Multiple Wear Warehouse|
|maxSAC|10|Empty order wear warehouse|
|Zs|false|Whether to stop loss|
|ZsLong|false|Single currency floating loss and long order stop loss|
|ZsShort|false|Single currency floating loss short order stop loss|
|T0|600|Transfer/clearance threshold|
|T1|100|Transfer/clearance value|
|S|10|Polling time(s)|
...
|Close a position with one click|__button__|Close a position with one click|
