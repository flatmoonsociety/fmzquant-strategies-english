...
Multi-timeframe-RSICCI Bollinger-Band-DCA-Strategy Multi-timeframe-RSICCI Bollinger-Band-DCA-Strategy
> Author
...
![IMG](assets/images/b66a81ede903da32d39e79a2176601ff34359cf1a24a6d57ab29869e23620f4e.png)
[trans]

## Overview
This strategy is a trend following strategy. It uses multiple indicators such as RSI, CCI and Bollinger Bands to determine the trend direction on different time frames, and implements DCA entry in batches to chase the trend and make profits.
## Strategy Principle
1. Calculate the RSI and CCI indicators on the 5-minute, 15-minute and 30-minute time frames respectively.
2. When the RSI of the shorter period is lower than a certain value and the RSI of the longer period is also lower than a certain value, it is judged to be overbought. When the RSI of the shorter period is higher than a certain value and the RSI of the longer period is also higher than a certain value, it is judged to be oversold. The judgment logic of CCI indicator is similar to RSI.
3. Bollinger Bands are used as an auxiliary judgment indicator to determine whether the price is too far from the middle track.
4. Gradually enter long positions when overbought, and gradually enter short positions when oversold to achieve the DCA effect.
## Advantage Analysis
1. Combine judgments with multiple time frame indicators to improve judgment accuracy
2. DCA strategy to reduce the cost of buying points
3. You can customize the proportion of each order to the total funds to control risks
## Risk Analysis
1. Risk of missing the best entry point
2. Trend reversal risk
3. Improper parameters lead to excessive trading risks
Solution:
1. Optimize parameters to ensure that indicator parameters match
2. Combine more indicators to determine trends
3. Adjust the quantity proportion of each order
## Optimization direction
1. Test more combinations of indicators to find the best combination
2. Optimize the quantity ratio of each order
3. Add stop loss strategy
## Summarize
This strategy uses multi-time frame RSI and CCI to determine the direction of the trend. When overbought and oversold, DCA orders are placed in batches to enter the market. When the market shows greater directionality, it has a very good effect of tracking the trend and making profits. However, improper parameter settings can also easily lead to over-trading. Generally speaking, this strategy has a large space for parameter and stop loss optimization, and can achieve better results after optimization.
||
