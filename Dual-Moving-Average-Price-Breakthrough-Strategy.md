...
![IMG](assets/images/b5f244339f2e0680af0025ee5a48a772e6b2b32192469b804ea2282bfaa20b86.png)

[trans]
### Overview
This strategy uses two moving averages to determine price trends and breakouts. Go short when the price goes above the upper track, go long when the price goes below the lower track, and set a stop-loss exit to control risks.
### Strategy Principles
1. Use the sma() function to calculate the short-term and long-term moving averages, which serve as the upper and lower rails of the trading strategy respectively.
2. Calculate the buying price and selling price: the buying price is the lower track multiplied by a coefficient less than 1, and the selling price is the upper track multiplied by a coefficient greater than 1.
3. When the price goes above the upper band, open a short position with a market price order; when the price goes below the lower band, open a long position with a limit order.
4. Set the year, month and date range to control the trading period of the strategy.
5. When the backtest ends or the date range is exceeded, all positions will be closed.
### Advantage Analysis
This strategy has the following advantages:
1. Using a dual-track system, you can filter market noise and identify trends.
2. Using price breakthroughs to determine entry timing can reduce false signals. 
3. Use limit orders to reduce market impact costs.
4. You can easily adjust the trading cycle and control strategic risks.
### Risk Analysis
This strategy also has some risks:
1. Double-track breakthroughs are prone to the risk of continuous losses. Stop loss Exit can be set to control losses.
2. When the trading target enters consolidation, there is a risk of excessive trading. The distance between the upper and lower rails can be appropriately relaxed.
3. Limit orders may cause some buying opportunities to be missed. Consider using market orders instead.
### Optimization direction
This strategy can be optimized from the following aspects:
1. Test moving average combinations of different lengths to find the best parameters.
2. Add the Volumes indicator to determine volume breakthroughs.
3. Add an adaptive stop loss mechanism and adjust the stop loss price in real time.
4. Add a machine learning model to determine the trend direction.
### Summarize
The overall idea of ​​this strategy is clear and easy to understand. Through the dual-track system to identify trends and price breakthroughs to determine the timing of entry, noise can be filtered out to achieve stable profits. There is also some room for improvement and optimization. Overall, it is a reproducible quantitative trading strategy with practical value.
||
