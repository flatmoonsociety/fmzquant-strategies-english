...
This article will detail a quantitative strategy for trading breakouts based on price swing highs and lows. This strategy generates trading signals by identifying breakouts of key price areas.
...
The biggest advantage of this strategy is that the breakthrough judgment rules are simple, clear and easy to implement.
...
First of all, it is impossible to accurately judge the trend based on breakthroughs alone, and false signals may appear.
Secondly, parameter optimization is not performed, and the strategy stability is limited.
Finally, the stop-profit and stop-loss settings need to be optimized to take into account the profit-loss ratio.
4. Content summary
This article details a quantitative trading strategy based on price swing high and low breakouts. It identifies trading opportunities by identifying breakouts of key price areas. The concept of this strategy is clear and simple, but it also needs to improve parameter settings and other issues. Overall, it provides a unique breakthrough idea.
||
