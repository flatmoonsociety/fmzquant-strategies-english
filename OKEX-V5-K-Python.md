...
Since the OKEX V5 interface can only call up to 100 links at a time, it needs to be queried in pages. Therefore, an example is encapsulated, how to query the K-line interface in pages and obtain the data of 1440 K-lines.
```js
function main() {
    // 访问接口获取数据
