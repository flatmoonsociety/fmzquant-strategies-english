...
|----|----|----|
|config1||Following configuration 1|
|config2||Following configuration 2|
|config3||Following configuration 3|
|config4||Following configuration 4|
|config5||Following configuration 5|
|amountPrecision|3|Amount Precision|
