...
OKex futures is troublesome to use, so I wrote such a framework to make it easier for new users to understand and use. Note that ETH is priced at $10 per coin.
> Strategy Arguments
