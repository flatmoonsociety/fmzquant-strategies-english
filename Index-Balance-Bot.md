...
Index-Balance-Bot Index-Balance-Bot
> Author
...
Index balancing strategy. Assets can be balanced according to preset proportions, supporting cross-exchange balancing. Note that two exchanges must be added adjacent to each other.
