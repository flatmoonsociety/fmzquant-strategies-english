...
TradingView Signal Execution Strategy 21 Tutorial
> Author
...
|FMZ_AccessKey|Note that it is the AccessKey of the FMZ platform, not the KEY of the exchange|The AccessKey of the FMZ platform|
|FMZ_SecretKey|Note that it is the SecretKey of the FMZ platform, not the KEY of the exchange|The SecretKey of the FMZ platform|
|maxBuffSignalRowDisplay|The maximum number of signal display rows in the status bar. Setting 20 will display the latest 20 signal records|Maximum number of signal display rows|
...
|----|----|----|
|TestSignal| is only used to simulate the webhook request sent by TradingView |Test Signal|
|evalCode|Execute Javascript code directly, which can be used for testing, switching simulation disks and other operations|Execute Javascript code|
