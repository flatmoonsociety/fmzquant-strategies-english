...
Adaptive-Grid-Trading-Strategy-Based-on-Quantitative-Trading-Platform based on quantitative trading platform
> Author
...
## Strategy Principle
1. Set the upper and lower price limits of the grid. You can automatically calculate the price of the highest and lowest points of historical prices within a certain range as the upper and lower limits, or you can manually set fixed upper and lower limit prices.
2. Calculate the price interval of each grid based on the upper and lower price limits and the number of grids.
3. Between the upper and lower price limits, arrange multiple buying and selling points at equal intervals as a grid.
4. When the market price breaks through the lower limit of the grid, place a buy order in the grid next to the grid where the latest open order is located; when the market price breaks through the upper limit of the grid, place a sell order in the grid above the grid where the latest open order is located.
5. In this way, buying and selling operations are continuously performed between the upper and lower limits of the grid. When the price trend reverses, previous orders are gradually stopped in profit or loss.
## Strategic Advantages
1. Grid trading can make profits in sideways and volatile markets.
2. Adaptively adjust the grid range, which can be automatically adjusted according to market fluctuations without manual intervention.
3. You can preset the amount of investment funds and distribute them proportionally on each grid to control the risk of each order.
4. Simple logic, easy to understand, and flexible parameter adjustment.
## Risks and Countermeasures
1. Breaking through the upper and lower limits and causing losses
- Solution: Set the stop loss position reasonably.
2. Trending market leads to repeated losses
- Solution: Identify the trend and suspend trading in time.
3. Improper parameter settings
- Solution: Adjust the grid quantity and price spacing parameters.
## Optimization direction
1. Use machine learning to predict the range and trend of price fluctuations and dynamically adjust grid parameters.
2. In the trending market, switch to trend trading to avoid losses in grid trading.
3. Conduct risk control based on indicators such as capital utilization rate and yield rate.
4. Spread multiple varieties and expand the scope of fund application.
## Summarize
This strategy is a parameter-adaptive grid strategy that can be automatically adjusted. It is suitable for stocks, digital currencies and foreign exchange varieties that fluctuate sideways. With the adjustment of Parameter parameters, it can adapt to different market conditions and has certain practical value.
||
