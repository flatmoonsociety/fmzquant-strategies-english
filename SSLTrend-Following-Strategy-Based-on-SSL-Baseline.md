...
Trend-Following-Strategy-Based-on-SSL-Baseline based on SSL
> Author
...
![IMG](assets/images/d3746e61175668b6c9d2fb2ffa18bf02699c9e21ef5c166891432d3bd86ece78.png)
 [trans]

## Overview
This strategy is a strategy that uses the SSL channel indicator to determine market trends and follows the trend based on the moving average. It is suitable for medium and long-term 4-hour and daily lines.
## Strategy Principle
1. The SSL channel consists of Celtic moving average and true amplitude. It can determine the direction of market trends. When the price breaks through the upper band, it is a bullish signal, and when it breaks through the lower band, it is a bearish signal.
2. The strategy uses moving average indicators such as EMA to calculate a baseline moving average. This moving average can filter out some false breakthroughs.
3. The strategy will go long when the price breaks through the SSL upper track, and go short when the price breaks through the SSL lower track. In an upward trend, chase the rise and kill the fall, and in the downward trend, buy the bottom and pick up the knife.
4. Stop loss methods include percentage stop loss, ATR stop loss and look back to the lowest price/highest price stop loss. Take profit is N times the stop loss. Specific parameters are determined by the user.
## Advantage Analysis
1. The SSL channel accurately determines the trend direction and reduces false signals. Combine it with the moving average as the basis for entering the market to avoid chasing the top and killing the bottom.
2. Different types of moving averages can be flexibly selected to adapt to a wider range of market conditions.
3. Stop loss methods are flexible and diverse, and risks can be controlled. The take-profit multiple can also be set flexibly to meet different preferences.
4. You can go long and short at the same time to fully tap the two-way market opportunities.
## Risk Analysis
1. There is a lag in the moving average indicators, and losses may accumulate.
2. In a volatile market, there will be a reversal as soon as it breaks through the upper and lower rails, and it is easy to get trapped.
3. ATR and lookback stop loss may be too loose during abnormal breakthroughs, causing losses to expand.
Risk response measures:
1. Adjust the moving average parameters appropriately, or choose other types of moving averages.
2. Increase the stop loss range and stop the loss in time.
3. Add a multiple factor to ATR, or adjust the lookback period.
## Optimization direction
1. Test more types of moving average indicators and find the best parameters.
2. Optimize the ATR period parameters of stop loss. 
3. Test different stop loss multiple parameters.
4. Test different take-profit risk factors.
## Summarize
This strategy comprehensively uses SSL to determine the trend and moving average indicators to confirm market entry, and can effectively follow the trend. It provides flexible stop loss and take profit methods to obtain higher returns while controlling risks. By constantly testing and optimizing parameters, better trading performance can be achieved. It's an effective strategy worth tracking and investing in over the long term.
|| 
