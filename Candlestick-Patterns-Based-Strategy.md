...
Candlestick-Patterns-Based-Strategy
> Author
...
## Overview
This strategy is based on candle chart patterns, identifies different candle line pattern signals, and conducts trend following transactions. Combined with risk management methods such as stop loss, take profit, and trailing stop, it aims to reduce the impact of market fluctuations on the strategy.
## Strategy Principle
This strategy mainly makes signal judgments based on the following candle patterns:
- Engulfing Patterns: Identify bullish and bearish engulfing patterns
- Gravity Lines/Dark Cloud Covers: Identify bullish gravity lines and bearish dark cloud cover patterns
- Doji: Identify Bullish Doji and Bearish Doji patterns
- Morning Star/Evening Star: Identify bullish morning star and bearish evening star patterns
- Belt-catching lines: Identify bullish and short belt-catching line patterns
- Three Crows/Three White Soldiers: Identify the three crows and three white soldiers forms
- Southern Samsung: Identify the Southern Samsung pattern
- Toast line: identify the shape of toast line
- Conference Lines: Identify long and short conference line patterns
- Kick line: identify long and short kick line patterns
- Ladder bottom: identify the shape of the ladder bottom
When the above candle signal is recognized, place an order with a fixed stop loss and take profit near the opening price of the second bar, and perform trend following transactions. At the same time, risk management is carried out in conjunction with trailing stop loss and trailing take profit.
In addition, the strategy also adds an moving average filter, which only considers signals when the price breaks through the moving average.
## Strategic Advantages
1. Based on the classic candle form, it has certain Universal attributes.
2. Strictly follow the morphological rules for mechanical trading without subjective influence.
3. The stop-loss and stop-profit settings are reasonable to control the risk of a single transaction to the greatest extent.
4. Add a moving stop-loss and take-profit mechanism, which can adjust the stop-loss line with the market.
5. Moving average filtering increases the basis for judgment and avoids being trapped.

## Risks and Countermeasures
1. There is a certain recognition error rate for candle patterns, and false signals may occur. Form parameters can be adjusted appropriately and invalid forms can be filtered out.
2. Static stop loss cannot completely avoid the risk of market emergencies. You can set a wider stop loss or use a trailing stop loss.
3. This strategy is sensitive to trading hours and cannot run 24 hours a day. You can adjust the trading time or add call auction filtering.
4. Moving average filtering may miss some opportunities. You can reduce the moving average period or cancel the moving average filtering.
5. Long signals and short signals cannot be grasped at the same time, which makes it difficult to make profits at the same time. Strategies can be formulated separately for long and short positions and run in a time-sharing manner.
## Optimization direction
1. Optimize the parameters of candle patterns to improve the recognition effect.
2. Test different trailing stop methods to find the optimal solution.
3. Try more advanced risk management methods, such as fund management, volatility stop loss, etc.
4. Add more filtering indicators to improve the filtering effect.
5. Try machine learning and other methods to establish a judgment model for candle patterns.
6. Develop strategy logic that takes into account both long and short signals.
## Summarize
This strategy uses classic candlestick patterns to determine trends and conduct transactions in a mechanized manner. Manage risk through strict stop loss and trailing stop loss, and improve judgment effect through moving average filtering. This strategy has the advantages of being easy to understand and implement, but it also has certain identification errors and difficulties in obtaining customized parameters. In the future, optimization can be achieved by introducing more technical indicators and machine learning to obtain better strategic effects.
||
