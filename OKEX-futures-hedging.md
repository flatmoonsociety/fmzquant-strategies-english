...
Futures and spot hedging is arbitrage using the price difference between futures and spot prices. Because on the delivery day, futures will be traded at the spot price, and once there is a price difference between futures and spot, you can obtain risk-free profit from the price difference by shorting futures and going long on spot (or going long on futures and selling spot).
For example, the current price of BTC is 20,000 knives per unit, and the futures price is 25,000 knives per unit. At this time, I bought 1 spot BTC and shorted one futures BTC. When the transaction is completed, I will get a risk-free profit of $5,000.
The risk of futures and spot hedging is very low. According to the current market situation of OKEX, it can roughly achieve an annualized return of 40%-50%. In extreme bullish and bearish market conditions, profits will be even higher.
Strategy logic: This strategy will automatically detect the price difference between spot and futures on OKEX. When the price difference reaches the expected profit threshold, profits will be obtained through equal hedging.
Strategy features:
Supports all futures varieties on OKEX (BTC, EOS, BCH, ETH, etc.)
Support custom leverage multiples and contract types (current week, next week, etc.)
Support custom profit expectations (such as 40% annualized profit)
Detailed reporting (including detailed strategy status, trading history, profit tracking, etc.)
Fully automatic hedging, no manual operation required
Risks to be faced: Risk of exchange running away
Supported platform: Botvs/FMZ
Detailed description of strategy parameters: https://www.pcclean.io/7w0e
