...
After the strategy is launched, it continuously tracks the highest price. If the highest price falls back to a certain percentage, the profit will be taken. For example, if the recent highest price is 100 and the take-profit ratio is 0.98, the profit will be taken if the price falls to 98.
> Strategy Arguments
