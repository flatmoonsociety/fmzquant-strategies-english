...
Sky Monkey - Long and Short Competition - Explosive Edition
> Author
...
- Rely on the strength of long and short positions as the conditions for opening a position
- Fixed take profit and stop loss points
- The name is random, learn to use it, and use it with caution in the real market.
> Strategy Arguments
...
|----|----|----|
|DepthLevel|5|Depth of Handicap Statistics|
|EnterPeriod|2|Observation Period|
|CalcInterval|10|Observation polling period (seconds)|
|DiffRatio|2.1|Coin multiple|
|PositionRatio|0.8|Position Ratio|
|StopProfit|0.02|Stop Profit (Percent)|
|StopLoss|0.01|Stop Loss (Percent)|
|Interval|true|Price polling period (seconds)|
